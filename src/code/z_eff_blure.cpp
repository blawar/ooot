...
void EffectBlure_GetComputedValues(EffectBlure* pthis, s32 index, f32 ratio, Vec3s* vec1, Vec3s* vec2,
...
void EffectBlure_DrawElemNoInterpolation(EffectBlure* pthis, EffectBlureElement* elem, s32 index,
...
void EffectBlure_DrawElemHermiteInterpolation(EffectBlure* pthis, EffectBlureElement* elem, s32 index,
                                              GraphicsContext* gfxCtx) {
...

    {
        ...
        for (i = 0; i < pthis->numElements - 1; i++) {
            if (pthis->drawMode == 1) {
                ...
                gDPSetPrimColor(POLY_XLU_DISP++, 0x00, 0x80, pthis->altPrimColor.r, pthis->altPrimColor.g,
                                pthis->altPrimColor.b, pthis->altPrimColor.a * (1.0f - alphaRatio));
                gDPPipeSync(POLY_XLU_DISP++);
            }
