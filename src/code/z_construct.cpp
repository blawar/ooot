...
void func_801109B0(GlobalContext* globalCtx)
{
	...
	interfaceCtx->unk_244 = interfaceCtx->aAlpha = interfaceCtx->bAlpha = interfaceCtx->cLeftAlpha = interfaceCtx->cDownAlpha = interfaceCtx->cRightAlpha = interfaceCtx->healthAlpha = interfaceCtx->startAlpha = interfaceCtx->magicAlpha = 0;
	...
	osSyncPrintf("Register_Item[%x, %x, %x, %x]\n", gSaveContext.equips.buttonItems[0], gSaveContext.equips.buttonItems[1], gSaveContext.equips.buttonItems[2], gSaveContext.equips.buttonItems[3]);
	...
	{
		interfaceCtx->iconItemSegment1 = (u8*)icon_item_static_lut[gSaveContext.equips.buttonItems[0]];
	}
	...
	{
		interfaceCtx->iconItemSegment2 = (u8*)icon_item_static_lut[gSaveContext.equips.buttonItems[1]];
	}

	if(gSaveContext.equips.buttonItems[2] < 0xF0)
	{
		interfaceCtx->iconItemSegment3 = (u8*)icon_item_static_lut[gSaveContext.equips.buttonItems[2]];
	}

	if(gSaveContext.equips.buttonItems[3] < 0xF0)
	{
		interfaceCtx->iconItemSegment4 = (u8*)icon_item_static_lut[gSaveContext.equips.buttonItems[3]];
	}

	osSyncPrintf("EVENT=%d\n", ((void)0, gSaveContext.timer1State));

	if((gSaveContext.timer1State == 4) || (gSaveContext.timer1State == 8) || (gSaveContext.timer2State == 4) || (gSaveContext.timer2State == 10))
	{
