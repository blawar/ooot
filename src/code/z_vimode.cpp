...
void ViMode_Configure(ViMode* viMode, s32 mode, s32 type, s32 unk_70, s32 unk_74, s32 unk_78, s32 unk_7C, s32 width, s32 height, s32 unk_left, s32 unk_right, s32 unk_top, s32 unk_bottom)
{
	...
	viMode->customViMode.comRegs.ctrl = OS_VI_UNK2000 | OS_VI_UNK1000 | OS_VI_GAMMA | OS_VI_GAMMA_DITHER | (!cond_44 ? OS_VI_UNK40 : 0) | (not_74 ? OS_VI_DIVOT : 0) | (not_7C ? OS_VI_UNK2 | OS_VI_UNK1 : OS_VI_UNK2);
...
void ViMode_Update(ViMode* viMode, Input* input)
{
	...
	if((viMode->viModeBase == 1) || (viMode->viModeBase == 2) || (viMode->viModeBase == 3))
	{
		...
		ViMode_Configure(viMode, OS_VI_UNK28, osTvType, viMode->unk_70, viMode->unk_74, viMode->unk_78, viMode->unk_7C, viMode->viWidth, viMode->viHeight, viMode->unk_5C, viMode->unk_58, viMode->unk_64, viMode->unk_60);
