...
void func_800C0F28(PreRender* pthis, Gfx** gfxp, void* buf, void* bufSave)
{
	...
	while(x > 0)
	{
		...
		gDPLoadTextureTile(gfx++, buf, G_IM_FMT_RGBA, G_IM_SIZ_16b, pthis->width, pthis->height, uls, ult, lrs, lrt, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);
...
void func_800C1258(PreRender* pthis, Gfx** gfxp)
{
	...
	while(y > 0)
	{
		...
		gDPLoadTextureTile(
		    gfx++, pthis->fbufSave, G_IM_FMT_RGBA, G_IM_SIZ_16b, pthis->widthSave, pthis->height - 1, pthis->ulxSave, ult, pthis->lrxSave, lrt, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD,
		    G_TX_NOLOD);
		gSPTextureRectangle(gfx++, pthis->ulx << 2, uly << 2, pthis->lrx << 2, (uly + dy - 1) << 2, G_TX_RENDERTILE, pthis->ulxSave << 5, ult << 5, 4 << 10, 1 << 10);
...
void func_800C170C(PreRender* pthis, Gfx** gfxp, void* fbuf, void* fbufSave, u32 r, u32 g, u32 b, u32 a)
{
	...
	while(x > 0)
	{
		...
		gDPLoadTextureTile(gfx++, fbuf, G_IM_FMT_RGBA, G_IM_SIZ_16b, pthis->width, pthis->height, uls, ult, lrs, lrt, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);
...
void func_800C1B24(PreRender* pthis, Gfx** gfxp, void* fbuf, void* cvgSave)
{
	...
	while(x > 0)
	{
		...
		gDPLoadTextureTile(gfx++, fbuf, G_IM_FMT_IA, G_IM_SIZ_16b, pthis->width, pthis->height, uls, ult, lrs, lrt, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);
...
void func_800C213C(PreRender* pthis, Gfx** gfxp)
{
	...
	if(pthis->cvgSave != NULL)
	{
		...
		gDPSetOtherMode(
		    gfx++, G_AD_DISABLE | G_CD_DISABLE | G_CK_NONE | G_TC_FILT | G_TF_POINT | G_TT_NONE | G_TL_TILE | G_TD_CLAMP | G_TP_NONE | G_CYC_2CYCLE | G_PM_NPRIMITIVE,
		    G_AC_NONE | G_ZS_PRIM | AA_EN | CVG_DST_CLAMP | ZMODE_OPA | CVG_X_ALPHA | GBL_c1(G_BL_CLR_IN, G_BL_0, G_BL_CLR_IN, G_BL_1) | GBL_c2(G_BL_CLR_IN, G_BL_0, G_BL_CLR_IN, G_BL_1));
		...
		while(y > 0)
		{
			...
			gDPLoadMultiTile(
			    gfx++, pthis->fbufSave, 0x0000, G_TX_RENDERTILE, G_IM_FMT_RGBA, G_IM_SIZ_16b, pthis->width, pthis->height, uls, ult, lrs, lrt, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD,
			    G_TX_NOLOD);

			gDPLoadMultiTile(
			    gfx++, pthis->cvgSave, 0x0160, rtile, G_IM_FMT_I, G_IM_SIZ_8b, pthis->width, pthis->height, uls, ult, lrs, lrt, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);
		...
		for(x = 1; x < pthis->width - 1; x++)
		{
			...
			if(((HREG(80) == 0xF) ? HREG(81) : 0) != 0)
			{
				...
				else
				{
					...
					{
						osSyncPrintf(
						    "red=%3d %3d %3d %3d grn=%3d %3d %3d %3d blu=%3d %3d %3d %3d \n", temp_s0[0], temp_s0[1], temp_s0[2], MEDIAN3(temp_s0[0], temp_s0[1], temp_s0[2]), temp_s1[0], temp_s1[1], temp_s1[2],
						    MEDIAN3(temp_s1[0], temp_s1[1], temp_s1[2]), temp_s2[0], temp_s2[1], temp_s2[2], MEDIAN3(temp_s2[0], temp_s2[1], temp_s2[2]));
					}
