...
DrawItemTableEntry sDrawItemTable[] = {
    ...
    {GetItem_DrawWallet, {gGiWalletDL, gGiAdultWalletColorDL, gGiAdultWalletRupeeOuterColorDL, gGiWalletRupeeOuterDL, gGiAdultWalletStringColorDL, gGiWalletStringDL, gGiAdultWalletRupeeInnerColorDL, gGiWalletRupeeInnerDL}},
    // giant's wallet, OBJECT_GI_PURSE
    {GetItem_DrawWallet, {gGiWalletDL, gGiGiantsWalletColorDL, gGiGiantsWalletRupeeOuterColorDL, gGiWalletRupeeOuterDL, gGiGiantsWalletStringColorDL, gGiWalletStringDL, gGiGiantsWalletRupeeInnerColorDL, gGiWalletRupeeInnerDL}},
    ...
    {GetItem_DrawPotion, {gGiPotionPotDL, gGiGreenPotColorDL, gGiGreenLiquidColorDL, gGiPotionLiquidDL, gGiGreenPatternColorDL, gGiPotionPatternDL}},
    // red potion, OBJECT_GI_LIQUID
    {GetItem_DrawPotion, {gGiPotionPotDL, gGiRedPotColorDL, gGiRedLiquidColorDL, gGiPotionLiquidDL, gGiRedPatternColorDL, gGiPotionPatternDL}},
    // blue potion, OBJECT_GI_LIQUID
    {GetItem_DrawPotion, {gGiPotionPotDL, gGiBluePotColorDL, gGiBlueLiquidColorDL, gGiPotionLiquidDL, gGiBluePatternColorDL, gGiPotionPatternDL}},
    ...
    {GetItem_DrawOpa10Xlu32, {gGiGauntletsDL, gGiSilverGauntletsColorDL, gGiGauntletsPlateDL, gGiSilverGauntletsPlateColorDL}},
    // golden gauntlets, OBJECT_GI_GLOVES
    {GetItem_DrawOpa10Xlu32, {gGiGauntletsDL, gGiGoldenGauntletsColorDL, gGiGauntletsPlateDL, gGiGoldenGauntletsPlateColorDL}},
    ...
    {GetItem_DrawBulletBag, {gGiBulletBagDL, gGiBulletBagColorDL, gGiBulletBagStringDL, gGiBulletBagStringColorDL, gGiBulletBagWritingDL}},
    ...
    {GetItem_DrawPoes, {gGiGhostContainerLidDL, gGiGhostContainerGlassDL, gGiGhostContainerContentsDL, gGiBigPoeColorDL}},
    ...
    {GetItem_DrawBulletBag, {gGiBulletBagDL, gGiBulletBag50ColorDL, gGiBulletBagStringDL, gGiBulletBag50StringColorDL, gGiBulletBagWritingDL}},
...
void GetItem_DrawMaskOrBombchu(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 556);

	func_80093BA8(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 560), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 565);
}
...
void GetItem_DrawSoldOut(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 572);

	POLY_XLU_DISP = Gfx_CallSetupDL(POLY_XLU_DISP, 5);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 576), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[0]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 581);
}
...
void GetItem_DrawBlueFire(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 588);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 592), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	func_80093D84(globalCtx->gfxCtx);
	gSPSegment(POLY_XLU_DISP++, 0x08, Gfx_TwoTexScroll(globalCtx->gfxCtx, 0, 0 * (globalCtx->frames * 0), 0 * (globalCtx->frames * 0), 16, 32, 1, 1 * (globalCtx->frames * 1), 1 * -(globalCtx->frames * 8), 16, 32));
	Matrix_Push();
	Matrix_Translate(-8.0f, -2.0f, 0.0f, MTXMODE_APPLY);
	func_800D1FD4(&globalCtx->billboardMtxF);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 615), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[1]);
	Matrix_Pop();

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 621);
}
...
void GetItem_DrawPoes(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 628);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 632), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	func_80093D84(globalCtx->gfxCtx);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 641), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[1]);
	gSPSegment(POLY_XLU_DISP++, 0x08, Gfx_TwoTexScroll(globalCtx->gfxCtx, 0, 0 * (globalCtx->frames * 0), 0 * (globalCtx->frames * 0), 16, 32, 1, 1 * (globalCtx->frames * 1), 1 * -(globalCtx->frames * 6), 16, 32));
	Matrix_Push();
	func_800D1FD4(&globalCtx->billboardMtxF);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 656), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[3]);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[2]);
	Matrix_Pop();

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 663);
}
...
void GetItem_DrawFairy(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 670);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 674), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	func_80093D84(globalCtx->gfxCtx);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 683), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[1]);
	gSPSegment(POLY_XLU_DISP++, 0x08, Gfx_TwoTexScroll(globalCtx->gfxCtx, 0, 0 * (globalCtx->frames * 0), 0 * (globalCtx->frames * 0), 32, 32, 1, 1 * (globalCtx->frames * 1), 1 * -(globalCtx->frames * 6), 32, 32));
	Matrix_Push();
	func_800D1FD4(&globalCtx->billboardMtxF);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 698), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[2]);
	Matrix_Pop();

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 704);
}
...
void GetItem_DrawMirrorShield(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 712);

	func_80093D18(globalCtx->gfxCtx);
	gSPSegment(
	    POLY_OPA_DISP++, 0x08,
	    Gfx_TwoTexScroll(
		globalCtx->gfxCtx, 0, (uintptr_t)(globalCtx->frames * 0) % 256, (uintptr_t)(globalCtx->frames * 2) % 256, 64, 64, 1, (uintptr_t)(globalCtx->frames * 0) % 128, (uintptr_t)(globalCtx->frames * 1) % 128, 32, 32));
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 723), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	func_80093D84(globalCtx->gfxCtx);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 730), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[1]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 735);
}
...
void GetItem_DrawSkullToken(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 742);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 746), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	func_80093D84(globalCtx->gfxCtx);
	gSPSegment(POLY_XLU_DISP++, 0x08, Gfx_TwoTexScroll(globalCtx->gfxCtx, 0, 0 * (globalCtx->frames * 0), 1 * -(globalCtx->frames * 5), 32, 32, 1, 0 * (globalCtx->frames * 0), 0 * (globalCtx->frames * 0), 32, 64));
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 760), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[1]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 765);
}
...
void GetItem_DrawEggOrMedallion(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 772);

	func_80093BA8(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 776), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[1]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 783);
}
...
void GetItem_DrawCompass(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 811);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 815), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	POLY_XLU_DISP = Gfx_CallSetupDL(POLY_XLU_DISP, 5);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 822), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[1]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 827);
}
...
void GetItem_DrawPotion(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 834);

	func_80093D18(globalCtx->gfxCtx);
	gSPSegment(POLY_OPA_DISP++, 0x08, Gfx_TwoTexScroll(globalCtx->gfxCtx, 0, -1 * (globalCtx->frames * 1), 1 * (globalCtx->frames * 1), 32, 32, 1, -1 * (globalCtx->frames * 1), 1 * (globalCtx->frames * 1), 32, 32));
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 845), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[1]);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);
	...
	func_80093D84(globalCtx->gfxCtx);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 855), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[4]);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[5]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 861);
}
...
void GetItem_DrawGoronSword(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 868);

	func_80093D18(globalCtx->gfxCtx);
	gSPSegment(POLY_OPA_DISP++, 0x08, Gfx_TwoTexScroll(globalCtx->gfxCtx, 0, 1 * (globalCtx->frames * 1), 0 * (globalCtx->frames * 1), 32, 32, 1, 0 * (globalCtx->frames * 1), 0 * (globalCtx->frames * 1), 32, 32));
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 878), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 883);
}
...
void GetItem_DrawDekuNuts(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 890);

	func_80093D18(globalCtx->gfxCtx);
	gSPSegment(POLY_OPA_DISP++, 0x08, Gfx_TwoTexScroll(globalCtx->gfxCtx, 0, 1 * (globalCtx->frames * 6), 1 * (globalCtx->frames * 6), 32, 32, 1, 1 * (globalCtx->frames * 6), 1 * (globalCtx->frames * 6), 32, 32));
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 901), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 906);
}
...
void GetItem_DrawRecoveryHeart(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 913);

	func_80093D84(globalCtx->gfxCtx);
	gSPSegment(POLY_XLU_DISP++, 0x08, Gfx_TwoTexScroll(globalCtx->gfxCtx, 0, 0 * (globalCtx->frames * 1), 1 * -(globalCtx->frames * 3), 32, 32, 1, 0 * (globalCtx->frames * 1), 1 * -(globalCtx->frames * 2), 32, 32));
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 924), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[0]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 929);
}
...
void GetItem_DrawFish(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 936);

	func_80093D84(globalCtx->gfxCtx);
	gSPSegment(POLY_XLU_DISP++, 0x08, Gfx_TwoTexScroll(globalCtx->gfxCtx, 0, 0 * (globalCtx->frames * 0), 1 * (globalCtx->frames * 1), 32, 32, 1, 0 * (globalCtx->frames * 0), 1 * (globalCtx->frames * 1), 32, 32));
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 947), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[0]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 952);
}
...
void GetItem_DrawOpa0(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 959);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 963), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 968);
}
...
void GetItem_DrawOpa0Xlu1(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 975);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 979), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	func_80093D84(globalCtx->gfxCtx);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 986), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[1]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 991);
}
...
void GetItem_DrawXlu01(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 998);

	func_80093D84(globalCtx->gfxCtx);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1002), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[0]);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[1]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1008);
}
...
void GetItem_DrawOpa10Xlu2(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1015);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1019), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[1]);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	func_80093D84(globalCtx->gfxCtx);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1027), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[2]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1032);
}
...
void GetItem_DrawMagicArrow(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1039);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1043), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	func_80093D84(globalCtx->gfxCtx);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1050), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[1]);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[2]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1056);
}
...
void GetItem_DrawMagicSpell(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1063);

	func_80093D84(globalCtx->gfxCtx);
	gSPSegment(POLY_XLU_DISP++, 0x08, Gfx_TwoTexScroll(globalCtx->gfxCtx, 0, 1 * (globalCtx->frames * 2), 1 * -(globalCtx->frames * 6), 32, 32, 1, 1 * globalCtx->frames * 1, -1 * (globalCtx->frames * 2), 32, 32));
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1074), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[0]);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[1]);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[2]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1081);
}
...
void GetItem_DrawOpa1023(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1088);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1092), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[1]);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[2]);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[3]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1100);
}
...
void GetItem_DrawOpa10Xlu32(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1108);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1112), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[1]);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	func_80093D84(globalCtx->gfxCtx);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1120), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[3]);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[2]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1126);
}
...
void GetItem_DrawSmallRupee(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1133);

	Matrix_Scale(0.7f, 0.7f, 0.7f, MTXMODE_APPLY);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1140), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[1]);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	func_80093D84(globalCtx->gfxCtx);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1148), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[3]);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[2]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1154);
}
...
void GetItem_DrawScale(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1162);

	func_80093D84(globalCtx->gfxCtx);
	gSPSegment(POLY_XLU_DISP++, 0x08, Gfx_TwoTexScroll(globalCtx->gfxCtx, 0, 1 * (globalCtx->frames * 2), (globalCtx->frames * -2), 64, 64, 1, 1 * (globalCtx->frames * 4), (globalCtx->frames * -4), 32, 32));
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1173), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[2]);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[3]);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[1]);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[0]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1181);
}
...
void GetItem_DrawBulletBag(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1188);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1192), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[1]);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);

	func_80093D84(globalCtx->gfxCtx);
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1200), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[2]);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[3]);
	gSPDisplayList(POLY_XLU_DISP++, sDrawItemTable[drawId].dlists[4]);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1207);
}
...
void GetItem_DrawWallet(GlobalContext* globalCtx, s16 drawId)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1214);

	func_80093D18(globalCtx->gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_draw.c", 1218), G_MTX_MODELVIEW | G_MTX_LOAD);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[1]);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[0]);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[2]);
	gSPDisplayList(POLY_OPA_DISP++, sDrawItemTable[drawId].dlists[3]);
	...
	CLOSE_DISPS(globalCtx->gfxCtx, "../z_draw.c", 1230);
}
