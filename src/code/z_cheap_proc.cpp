...
void Gfx_DrawDListOpa(GlobalContext* globalCtx, Gfx* dlist)
{
	...
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_cheap_proc.c", 216), G_MTX_MODELVIEW | G_MTX_LOAD);
...
void Gfx_DrawDListXlu(GlobalContext* globalCtx, Gfx* dlist)
{
	...
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_cheap_proc.c", 230), G_MTX_MODELVIEW | G_MTX_LOAD);
