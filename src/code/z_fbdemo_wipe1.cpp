...
Gfx sWipeDList[] = {
    ...
    gsDPLoadTextureBlock_4b(oot::asset::texture::load(symbol::sWipe1Tex), G_IM_FMT_I, 64, 64, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_MIRROR | G_TX_WRAP, 6, 6,
                            11, G_TX_NOLOD),
    gsDPLoadMultiBlock_4b(oot::asset::texture::load(symbol::sWipe1Tex), 0x0100, 1, G_IM_FMT_I, 64, 64, 0, G_TX_NOMIRROR | G_TX_WRAP,
                          G_TX_MIRROR | G_TX_WRAP, 6, 6, 11, 1),
    gsDPSetTextureLUT(G_TT_NONE),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    gsSPDisplayListSEG(SEGMENT_ADDRESS(0x08000000)),
    gsSPVertex(oot::asset::vtx::load(symbol::sWipe1Vtx), 25, 0),
