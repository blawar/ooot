...
u32 EffectSsKakera_Init(GlobalContext* globalCtx, u32 index, EffectSs* pthis, void* initParamsx)
{
	...
	if(initParams->dList != NULL)
	{
		...
		if(objId == OBJECT_GAMEPLAY_KEEP || objId == OBJECT_GAMEPLAY_FIELD_KEEP || objId == OBJECT_GAMEPLAY_DANGEON_KEEP)
		{
...
s32 func_809A9FD8(EffectSs* pthis, Vec3f* diff, f32 dist)
{
	static f32 (*D_809AA588[])(f32 dist, s32 arg1) = {
	    func_809A9DD8, func_809A9DEC, func_809A9DEC, func_809A9DEC, func_809A9E28, func_809A9E28, func_809A9E28, func_809A9E68, func_809A9E68, func_809A9E68,
	};
	f32 temp_f0;
	s32 temp_a1;
