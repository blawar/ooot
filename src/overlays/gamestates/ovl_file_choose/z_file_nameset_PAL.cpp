...
namespace oot::gamestate
{
	static s16 D_808124C0[] = {
	    0x0002, 0x0003, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0001, 0x0002, 0x0000, 0x0001, 0x0001, 0x0002, 0x0001, 0x0001, 0x0004, 0x0002, 0x0002, 0x0002,
	    0x0001, 0x0001, 0x0000, 0x0002, 0x0000, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001, 0x0000, 0x0001, 0x0001, 0x0001, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0003, 0x0002, 0x0002,
	    0x0004, 0x0003, 0x0002, 0x0004, 0x0001, 0x0002, 0x0002, 0x0001, 0x0001, 0x0002, 0x0002, 0x0003, 0x0002, 0x0002, 0x0000, 0x0002, 0x0002, 0x0002, 0x0000, 0x0003, 0x0001, 0x0000,
	};

	static s16 D_80812544[] = {
	    0x0001, 0x0002, 0x0000, 0x0001, 0x0001, 0x0002, 0x0001, 0x0001, 0x0004, 0x0002, 0x0002, 0x0002, 0x0001, 0x0001, 0x0000, 0x0002, 0x0000, 0x0001, 0x0001, 0x0001, 0x0001, 0x0001,
	    0x0000, 0x0001, 0x0001, 0x0001, 0x0002, 0x0002, 0x0002, 0x0002, 0x0002, 0x0003, 0x0002, 0x0002, 0x0004, 0x0003, 0x0002, 0x0004, 0x0001, 0x0002, 0x0002, 0x0001, 0x0001, 0x0002,
	...
	void FileChoose_DrawCharacter(GraphicsContext* gfxCtx, void* texture, s16 vtx)
	{
		...
		gDPLoadTextureBlock_4b(POLY_OPA_DISP++, texture, G_IM_FMT_I, 16, 16, 0, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);
	...
	{
		FileChoose* pthis = (FileChoose*)thisx;
		s16 val;
		s16 phi_t2;
		s16 phi_t0;
		s16 phi_t3;
		...
		pthis->keyboardVtx = (Vtx*)Graph_Alloc(pthis->gfxCtx, sizeof(Vtx) * 4 * 5 * 13);
		...
		for(phi_t2 = 0, phi_s2 = 0, phi_t3 = 0; phi_s2 < 5; phi_s2++)
		{
			...
			for(phi_t1 = 0; phi_t1 < 13; phi_t1++, phi_t3 += 4, phi_t2++)
			{
				...
				pthis->keyboardVtx[phi_t3 + 1].v.ob[0] = pthis->keyboardVtx[phi_t3 + 3].v.ob[0] = D_80812544[phi_t2] + phi_t0 + 12;
				...
				pthis->keyboardVtx[phi_t3].v.ob[2] = pthis->keyboardVtx[phi_t3 + 1].v.ob[2] = pthis->keyboardVtx[phi_t3 + 2].v.ob[2] = pthis->keyboardVtx[phi_t3 + 3].v.ob[2] = 0;

				pthis->keyboardVtx[phi_t3].v.flag = pthis->keyboardVtx[phi_t3 + 1].v.flag = pthis->keyboardVtx[phi_t3 + 2].v.flag = pthis->keyboardVtx[phi_t3 + 3].v.flag = 0;

				pthis->keyboardVtx[phi_t3].v.tc[0] = pthis->keyboardVtx[phi_t3].v.tc[1] = pthis->keyboardVtx[phi_t3 + 1].v.tc[1] = pthis->keyboardVtx[phi_t3 + 2].v.tc[0] = 0;

				pthis->keyboardVtx[phi_t3 + 1].v.tc[0] = pthis->keyboardVtx[phi_t3 + 2].v.tc[1] = pthis->keyboardVtx[phi_t3 + 3].v.tc[0] = pthis->keyboardVtx[phi_t3 + 3].v.tc[1] = 0x200;

				pthis->keyboardVtx[phi_t3].v.cn[0] = pthis->keyboardVtx[phi_t3 + 1].v.cn[0] = pthis->keyboardVtx[phi_t3 + 2].v.cn[0] = pthis->keyboardVtx[phi_t3 + 3].v.cn[0] = pthis->keyboardVtx[phi_t3].v.cn[1] =
				    pthis->keyboardVtx[phi_t3 + 1].v.cn[1] = pthis->keyboardVtx[phi_t3 + 2].v.cn[1] = pthis->keyboardVtx[phi_t3 + 3].v.cn[1] = pthis->keyboardVtx[phi_t3].v.cn[2] = pthis->keyboardVtx[phi_t3 + 1].v.cn[2] =
					pthis->keyboardVtx[phi_t3 + 2].v.cn[2] = pthis->keyboardVtx[phi_t3 + 3].v.cn[2] = pthis->keyboardVtx[phi_t3].v.cn[3] = pthis->keyboardVtx[phi_t3 + 1].v.cn[3] = pthis->keyboardVtx[phi_t3 + 2].v.cn[3] =
					    pthis->keyboardVtx[phi_t3 + 3].v.cn[3] = 255;
	...
	void FileChoose_SetNameEntryVtx(GameState* thisx)
	{
		...
		OPEN_DISPS(pthis->gfxCtx, "../z_file_nameset_PAL.c", 205);
		...
		pthis->nameEntryVtx = (Vtx*)Graph_Alloc(pthis->gfxCtx, 44 * sizeof(Vtx));
		...
		for(phi_s0 = 0, phi_t1 = 0; phi_t1 < 44; phi_t1 += 4, phi_s0++)
		{
			if((phi_s0 > 0) && (phi_s0 < 9))
			{
				...
				pthis->nameEntryVtx[phi_t1].v.ob[0] = pthis->nameEntryVtx[phi_t1 + 2].v.ob[0] = D_808125EC[phi_s0] + pthis->nameEntryBoxPosX + D_808124C0[temp];

				pthis->nameEntryVtx[phi_t1 + 1].v.ob[0] = pthis->nameEntryVtx[phi_t1 + 3].v.ob[0] = pthis->nameEntryVtx[phi_t1].v.ob[0] + 0xA;
			}
			else
			{
				pthis->nameEntryVtx[phi_t1].v.ob[0] = pthis->nameEntryVtx[phi_t1 + 2].v.ob[0] = D_808125EC[phi_s0] + pthis->nameEntryBoxPosX;
			...
			pthis->nameEntryVtx[phi_t1 + 2].v.ob[1] = pthis->nameEntryVtx[phi_t1 + 3].v.ob[1] = pthis->nameEntryVtx[phi_t1].v.ob[1] - 0xA;

			pthis->nameEntryVtx[phi_t1].v.ob[2] = pthis->nameEntryVtx[phi_t1 + 1].v.ob[2] = pthis->nameEntryVtx[phi_t1 + 2].v.ob[2] = pthis->nameEntryVtx[phi_t1 + 3].v.ob[2] = 0;

			pthis->nameEntryVtx[phi_t1].v.flag = pthis->nameEntryVtx[phi_t1 + 1].v.flag = pthis->nameEntryVtx[phi_t1 + 2].v.flag = pthis->nameEntryVtx[phi_t1 + 3].v.flag = 0;

			pthis->nameEntryVtx[phi_t1].v.tc[0] = pthis->nameEntryVtx[phi_t1].v.tc[1] = pthis->nameEntryVtx[phi_t1 + 1].v.tc[1] = pthis->nameEntryVtx[phi_t1 + 2].v.tc[0] = 0;

			pthis->nameEntryVtx[phi_t1 + 1].v.tc[0] = pthis->nameEntryVtx[phi_t1 + 2].v.tc[1] = pthis->nameEntryVtx[phi_t1 + 3].v.tc[0] = pthis->nameEntryVtx[phi_t1 + 3].v.tc[1] = 0x200;

			pthis->nameEntryVtx[phi_t1].v.cn[0] = pthis->nameEntryVtx[phi_t1 + 1].v.cn[0] = pthis->nameEntryVtx[phi_t1 + 2].v.cn[0] = pthis->nameEntryVtx[phi_t1 + 3].v.cn[0] = pthis->nameEntryVtx[phi_t1].v.cn[1] =
			    pthis->nameEntryVtx[phi_t1 + 1].v.cn[1] = pthis->nameEntryVtx[phi_t1 + 2].v.cn[1] = pthis->nameEntryVtx[phi_t1 + 3].v.cn[1] = pthis->nameEntryVtx[phi_t1].v.cn[2] = pthis->nameEntryVtx[phi_t1 + 1].v.cn[2] =
				pthis->nameEntryVtx[phi_t1 + 2].v.cn[2] = pthis->nameEntryVtx[phi_t1 + 3].v.cn[2] = pthis->nameEntryVtx[phi_t1].v.cn[3] = pthis->nameEntryVtx[phi_t1 + 1].v.cn[3] = pthis->nameEntryVtx[phi_t1 + 2].v.cn[3] =
				    pthis->nameEntryVtx[phi_t1 + 3].v.cn[3] = 0xFF;
		}
		...
		gDPPipeSync(POLY_OPA_DISP++);
		gDPSetCombineLERP(POLY_OPA_DISP++, PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, TEXEL0, 0, PRIMITIVE, 0, PRIMITIVE, ENVIRONMENT, TEXEL0, ENVIRONMENT, TEXEL0, 0, PRIMITIVE, 0);
		gDPSetPrimColor(POLY_OPA_DISP++, 0, 0, pthis->windowColor[0], pthis->windowColor[1], pthis->windowColor[2], pthis->nameEntryBoxAlpha);
		...
		CLOSE_DISPS(pthis->gfxCtx, "../z_file_nameset_PAL.c", 307);
	}
	...
	void FileChoose_DrawKeyboard(GameState* thisx)
	{
		...
		OPEN_DISPS(pthis->gfxCtx, "../z_file_nameset_PAL.c", 324);
	...
	void FileChoose_DrawNameEntry(GameState* thisx)
	{
		...
		OPEN_DISPS(pthis->gfxCtx, "../z_file_nameset_PAL.c", 368);

		FileChoose_SetKeyboardVtx(pthis);
		FileChoose_SetNameEntryVtx(pthis);
		FileChoose_PulsateCursor(pthis);
		...
		if((pthis->kbdButton == FS_KBD_BTN_HIRA) || (pthis->kbdButton == FS_KBD_BTN_KATA) || (pthis->kbdButton == FS_KBD_BTN_END))
		{
		...
		else
		{
			...
			{
				osSyncPrintf("mjp=%d  xpos=%d  ypos=%d  name_contents=%d\n", pthis->charIndex, pthis->kbdX, pthis->kbdY, pthis->kbdButton);
			}

			pthis->nameEntryVtx[40].v.ob[0] = pthis->nameEntryVtx[42].v.ob[0] = pthis->keyboardVtx[pthis->charIndex * 4].v.ob[0] - D_80812544[pthis->charIndex] - 6;
			pthis->nameEntryVtx[41].v.ob[0] = pthis->nameEntryVtx[43].v.ob[0] = pthis->nameEntryVtx[40].v.ob[0] + 24;
			pthis->nameEntryVtx[40].v.ob[1] = pthis->nameEntryVtx[41].v.ob[1] = pthis->keyboardVtx[pthis->charIndex * 4].v.ob[1] + 6;
		}
		...
		if((pthis->kbdButton == FS_KBD_BTN_HIRA) || (pthis->kbdButton == FS_KBD_BTN_KATA) || (pthis->kbdButton == FS_KBD_BTN_END))
		{
			gDPLoadTextureBlock(POLY_OPA_DISP++, gFileSelMediumButtonHighlightTex, G_IM_FMT_I, G_IM_SIZ_8b, 56, 24, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);
		}
		else if((pthis->kbdButton == FS_KBD_BTN_ENG) || (pthis->kbdButton == FS_KBD_BTN_BACKSPACE))
		{
			gDPLoadTextureBlock(POLY_OPA_DISP++, gFileSelSmallButtonHighlightTex, G_IM_FMT_I, G_IM_SIZ_8b, 40, 24, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);
		}

		gSP1Quadrangle(POLY_OPA_DISP++, 4, 6, 7, 5, 0);

		FileChoose_DrawKeyboard(pthis);
		gDPPipeSync(POLY_OPA_DISP++);
		func_800949A8(pthis->gfxCtx);
		...
		CLOSE_DISPS(pthis->gfxCtx, "../z_file_nameset_PAL.c", 550);
	}
	...
	void FileChoose_DrawOptionsImpl(GameState* thisx)
	{
		...
		OPEN_DISPS(pthis->gfxCtx, "../z_file_nameset_PAL.c", 848);
		...
		for(i = 0, vtx = 0; i < 4; i++, vtx += 4)
		{
			...
			if(i == gSaveContext.audioSetting)
			{
				...
				{
					gDPSetPrimColor(POLY_OPA_DISP++, 0, 0, cursorPrimRed, cursorPrimGreen, cursorPrimBlue, pthis->titleAlpha[0]);
		...
		gDPLoadTextureBlock_4b(POLY_OPA_DISP++, gFileSelBrightnessCheckTex, G_IM_FMT_IA, 96, 16, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);
		...
		gDPLoadTextureBlock_4b(POLY_OPA_DISP++, gFileSelOptionsDividerTex, G_IM_FMT_IA, 256, 2, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD);

		Matrix_Push();
		Matrix_Translate(0.0f, 0.1f, 0.0f, MTXMODE_APPLY);
		gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(pthis->gfxCtx, "../z_file_nameset_PAL.c", 1009), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
		...
		gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(pthis->gfxCtx, "../z_file_nameset_PAL.c", 1021), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
		...
		gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(pthis->gfxCtx, "../z_file_nameset_PAL.c", 1033), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
		gSPVertex(POLY_OPA_DISP++, gOptionsDividerBottomVtx, 4, 0);
		gSP1Quadrangle(POLY_OPA_DISP++, 0, 2, 3, 1, 0);
		Matrix_Pop();

		CLOSE_DISPS(pthis->gfxCtx, "../z_file_nameset_PAL.c", 1040);
	}
