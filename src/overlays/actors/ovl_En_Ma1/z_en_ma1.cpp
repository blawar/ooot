...
ActorInit En_Ma1_InitVars = {
    ACTOR_EN_MA1, ACTORCAT_NPC, FLAGS, OBJECT_MA1, ACTOR_FACTORY(EnMa1), (ActorFunc)EnMa1_Init, (ActorFunc)EnMa1_Destroy, (ActorFunc)EnMa1_Update, (ActorFunc)EnMa1_Draw, (ActorFunc)EnMa1_Reset,
};
