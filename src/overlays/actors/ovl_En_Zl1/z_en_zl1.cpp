...
void func_80B4B010(EnZl1* pthis, GlobalContext* globalCtx)
{
	...
	{
		Animation_Change(&pthis->skelAnime, &gChildZelda1Anim_10B38, 1.0f, 0.0f, Animation_GetLastFrame(&gChildZelda1Anim_10B38), ANIMMODE_ONCE_INTERP, -10.0f);
...
void func_80B4B8B4(EnZl1* pthis, GlobalContext* globalCtx)
{
	AnimationHeader* spB0[] = {
	    NULL, NULL, NULL, NULL, NULL, NULL, NULL, &gChildZelda1Anim_12B04, &gChildZelda1Anim_12118, &gChildZelda1Anim_10B38,
	};
	u8 spA4[] = {
	...
	if(npcAction != NULL)
	{
		...
		if(pthis->unk_1E6 != npcAction->action)
		{
			...
			Animation_Change(&pthis->skelAnime, spB0[npcAction->action], 1.0f, 0.0f, frameCount, spA4[npcAction->action], -10.0f);
...
void func_80B4BC78(EnZl1* pthis, GlobalContext* globalCtx)
{
	...
	if(npcAction != NULL)
	{
		...
		if(pthis->unk_1E6 != npcAction->action)
		{
			...
			Animation_Change(&pthis->skelAnime, sp90[npcAction->action], 1.0f, 0.0f, frameCount, sp84[npcAction->action], -10.0f);
			pthis->unk_1E6 = npcAction->action;
		}
		pthis->actor.velocity = velocity;
		if(globalCtx->csCtx.frames < npcAction->endFrame)
