...
static struct_80034EC0_Entry sAnimations[] = {
    {&gDogWalkAnim, 1.0f, 0.0f, -1.0f, ANIMMODE_LOOP, 0.0f}, {&gDogWalkAnim, 1.0f, 0.0f, -1.0f, ANIMMODE_LOOP, -6.0f},	      {&gDogRunAnim, 1.0f, 0.0f, -1.0f, ANIMMODE_LOOP, -6.0f}, {&gDogBarkAnim, 1.0f, 0.0f, -1.0f, ANIMMODE_LOOP, -6.0f},
    {&gDogSitAnim, 1.0f, 0.0f, 4.0f, ANIMMODE_ONCE, -6.0f},  {&gDogSitAnim, 1.0f, 5.0f, 25.0f, ANIMMODE_LOOP_PARTIAL, -6.0f}, {&gDogBowAnim, 1.0f, 0.0f, 6.0f, ANIMMODE_ONCE, -6.0f},  {&gDogBow2Anim, 1.0f, 0.0f, -1.0f, ANIMMODE_LOOP, -6.0f},
};
...
void EnDog_Update(Actor* thisx, GlobalContext* globalCtx)
{
	...
	Actor_UpdateBgCheckInfo(globalCtx, &pthis->actor, pthis->collider.dim.radius, pthis->collider.dim.height * 0.5f, 0.0f, 5);
