...
void DemoGj_InitCylinder(DemoGj* pthis, GlobalContext* globalCtx, ColliderCylinder* cylinder,
...
s32 DemoGj_InitSetIndexes(DemoGj* pthis, GlobalContext* globalCtx, s32 updateMode, s32 drawConfig,
...
void DemoGj_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (pthis->updateMode < 0 || pthis->updateMode >= ARRAY_COUNT(sUpdateFuncs) ||
        sUpdateFuncs[pthis->updateMode] == NULL) {
