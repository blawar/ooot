...
ActorInit En_Sb_InitVars = {
    ACTOR_EN_SB, ACTORCAT_ENEMY, FLAGS, OBJECT_SB, ACTOR_FACTORY(EnSb), (ActorFunc)EnSb_Init, (ActorFunc)EnSb_Destroy, (ActorFunc)EnSb_Update, (ActorFunc)EnSb_Draw, (ActorFunc)EnSb_Reset,
};
