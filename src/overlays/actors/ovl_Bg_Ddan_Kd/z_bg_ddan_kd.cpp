...
void BgDdanKd_CheckForExplosions(BgDdanKd* pthis, GlobalContext* globalCtx)
{
	...
	if((explosive != NULL) && (pthis->prevExplosive != NULL) && (explosive != pthis->prevExplosive) && (Math_Vec3f_DistXZ(&pthis->prevExplosivePos, &explosive->world.pos) > 80.0f))
	{
...
void BgDdanKd_LowerStairs(BgDdanKd* pthis, GlobalContext* globalCtx)
{
	...
	else
	{
		...
		Audio_PlaySoundGeneral(NA_SE_EV_PILLAR_SINK - SFX_FLAG, &pthis->dyna.actor.projectedPos, 4, &D_801333E0, &D_801333E0, &gReverbAdd2);
	}
}
