...
void func_80B98320(ObjMakekinsuta* pthis, GlobalContext* globalCtx)
{
	if(pthis->unk_152 != 0)
	{
		...
		{
			Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_EN_SW, pthis->actor.world.pos.x, pthis->actor.world.pos.y, pthis->actor.world.pos.z, 0, pthis->actor.shape.rot.y, 0, (pthis->actor.params | 0x8000));
