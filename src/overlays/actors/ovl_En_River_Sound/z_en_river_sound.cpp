...
void EnRiverSound_Draw(Actor* thisx, GlobalContext* globalCtx)
{
	...
	else if((pthis->actor.params == RS_UNK_0) || (pthis->actor.params == RS_UNK_4) || (pthis->actor.params == RS_UNK_5))
	{
	...
	else if((pthis->actor.params == RS_SANDSTORM) || (pthis->actor.params == RS_CHAMBER_OF_SAGES_1) || (pthis->actor.params == RS_CHAMBER_OF_SAGES_2) || (pthis->actor.params == RS_RUMBLING))
	{
