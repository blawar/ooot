...
void EnZl4_SetCsCameraMove(GlobalContext* globalCtx, s16 index)
{
	...
	Camera_SetCSParams(activeCam, sCsCameraMove[index].atPoints, sCsCameraMove[index].eyePoints, player, sCsCameraMove[index].relativeToPlayer);
}
...
{
	if((pthis->skelAnime.animation == &gChildZeldaAnim_01B874) || (pthis->skelAnime.animation == &gChildZeldaAnim_01BCF0) || (pthis->skelAnime.animation == &gChildZeldaAnim_0125E4) || (pthis->skelAnime.animation == &gChildZeldaAnim_012E58) ||
	   (pthis->skelAnime.animation == &gChildZeldaAnim_015F14) || (pthis->skelAnime.animation == &gChildZeldaAnim_0169B4) || (pthis->skelAnime.animation == &gChildZeldaAnim_016D08) || (pthis->skelAnime.animation == &gChildZeldaAnim_01805C) ||
	   (pthis->skelAnime.animation == &gChildZeldaAnim_01A2FC) || (pthis->skelAnime.animation == &gChildZeldaAnim_01AAE0) || (pthis->skelAnime.animation == &gChildZeldaAnim_01CE08) || (pthis->skelAnime.animation == &gChildZeldaAnim_018898) ||
	   (pthis->skelAnime.animation == &gChildZeldaAnim_01910C) || (pthis->skelAnime.animation == &gChildZeldaAnim_00F0A4) || (pthis->skelAnime.animation == &gChildZeldaAnim_00F894))
	{
		return true;
	}
	return false;
	...
	switch(pthis->talkState)
	{
		...
		case 6:
			...
			else
			{
				...
				func_8002F434(&pthis->actor, globalCtx, GI_LETTER_ZELDA, fabsf(pthis->actor.xzDistToPlayer) + 1.0f, fabsf(pthis->actor.yDistToPlayer) + 1.0f);
...
void EnZl4_TheEnd(EnZl4* pthis, GlobalContext* globalCtx)
{
	s32 animIndex[] = {ZL4_ANIM_0, ZL4_ANIM_0, ZL4_ANIM_0, ZL4_ANIM_0, ZL4_ANIM_0, ZL4_ANIM_0, ZL4_ANIM_0, ZL4_ANIM_26, ZL4_ANIM_21, ZL4_ANIM_3};
...
{
	EnZl4* pthis = (EnZl4*)thisx;
	void* mouthTex[] = {gChildZeldaMouthNeutralTex, gChildZeldaMouthHappyTex, gChildZeldaMouthWorriedTex, gChildZeldaMouthSurprisedTex};
	void* eyeTex[] = {
