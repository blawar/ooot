...
static s16 D_8089BA18[6][2] = {
    {0x0388, 0x0395}, {0x03EA, 0x03FF}, {0x0454, 0x0467}, {0x04B4, 0x04C1}, {0x0518, 0x0528}, {0x0581, 0x0590},
};
...
void BgJyaZurerukabe_InitDynaPoly(BgJyaZurerukabe* pthis, GlobalContext* globalCtx, CollisionHeader* collision, s32 flag)
{
	s32 pad;
	...
	{
		osSyncPrintf("Warning : move BG 登録失敗(%s %d)(name %d)(arg_data 0x%04x)\n", "../z_bg_jya_zurerukabe.c", 194, pthis->dyna.actor.id, pthis->dyna.actor.params);
	}
}
...
void func_8089B870(BgJyaZurerukabe* pthis, GlobalContext* globalCtx)
{
	if(Math_StepToF(&pthis->dyna.actor.world.pos.x, pthis->dyna.actor.home.pos.x + (pthis->unk_16C * 75), D_8089BA08[pthis->unk_168]))
	{
		func_8089B7B4(pthis);
	}
