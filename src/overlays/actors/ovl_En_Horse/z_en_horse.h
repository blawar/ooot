...
#define EN_HORSE_CHECK_4(horseActor)                                                                                                                                                                                                                           \
	(((((horseActor)->action == ENHORSE_ACT_MOUNTED_IDLE) || ((horseActor)->action == ENHORSE_ACT_FROZEN) || ((horseActor)->action == ENHORSE_ACT_MOUNTED_IDLE_WHINNEYING)) && !((horseActor)->stateFlags & ENHORSE_FLAG_19) &&                            \
	  !((horseActor)->stateFlags & ENHORSE_FLAG_25))                                                                                                                                                                                                       \
	     ? true                                                                                                                                                                                                                                            \
	     : false)
