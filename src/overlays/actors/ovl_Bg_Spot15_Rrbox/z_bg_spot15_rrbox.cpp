...
static Vec3f D_808B45DC[] = {
    {29.99f, 0.01f, -29.99f}, {-29.99f, 0.01f, -29.99f}, {-29.99f, 0.01f, 29.99f}, {29.99f, 0.01f, 29.99f}, {0.0f, 0.01f, 0.0f},
};
...
void func_808B3960(BgSpot15Rrbox* pthis, GlobalContext* globalCtx, CollisionHeader* collision, s32 flags)
{
	...
	{
		osSyncPrintf("Warning : move BG 登録失敗(%s %d)(name %d)(arg_data 0x%04x)\n", "../z_bg_spot15_rrbox.c", 171, pthis->dyna.actor.id, pthis->dyna.actor.params);
	}
}
...
s32 func_808B3A40(BgSpot15Rrbox* pthis, GlobalContext* globalCtx)
{
	...
	if((dynaPolyActor != NULL) && Math3D_Dist2DSq(dynaPolyActor->actor.world.pos.x, dynaPolyActor->actor.world.pos.z, pthis->dyna.actor.world.pos.x, pthis->dyna.actor.world.pos.z) < 0.01f)
	{
		return true;
	}
	return false;
...
s32 func_808B3CA0(BgSpot15Rrbox* pthis, GlobalContext* globalCtx, s32 arg2)
{
	...
	pthis->dyna.actor.floorHeight = BgCheck_EntityRaycastFloor6(&globalCtx->colCtx, &pthis->dyna.actor.floorPoly, &pthis->bgId, &pthis->dyna.actor, &actorPosition, chkDist);
...
{
	return !func_800435D8(globalCtx, &pthis->dyna, pthis->dyna.actor.scale.x * 290.0f, pthis->dyna.actor.scale.x * 290.0f + 20.0f, 1.0f);
}
