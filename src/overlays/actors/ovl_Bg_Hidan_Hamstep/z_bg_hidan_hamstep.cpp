...
static f32 sEffectPositions[][2] = {
    {-100.0f, 40.0f}, {100.0f, 40.0f}, {-100.0f, 0.0f}, {100.0f, 0.0f}, {-100.0f, -40.0f}, {100.0f, 40.0f}, {-100.0f, -80.0f}, {-50.0f, -80.0f}, {0.0f, -80.0f}, {50.0f, -80.0f}, {100.0f, -80.0f},
};
...
s32 BgHidanHamstep_SpawnChildren(BgHidanHamstep* pthis, GlobalContext* globalCtx2)
{
	...
	for(i = 0; i < 5; i++)
	{
		...
		step =
		    (BgHidanHamstep*)Actor_SpawnAsChild(&globalCtx->actorCtx, &step->dyna.actor, globalCtx, ACTOR_BG_HIDAN_HAMSTEP, pos.x, pos.y, pos.z, pthis->dyna.actor.world.rot.x, pthis->dyna.actor.world.rot.y, pthis->dyna.actor.world.rot.z, params);
...
void BgHidanHamstep_Init(Actor* thisx, GlobalContext* globalCtx)
{
	...
	if(Flags_GetSwitch(globalCtx, (pthis->dyna.actor.params >> 8) & 0xFF))
	{
		...
		{
			pthis->dyna.actor.world.pos.y = sYPosOffsets[(pthis->dyna.actor.params & 0xFF) - 1] + pthis->dyna.actor.home.pos.y;
			BgHidanHamstep_SetupAction(pthis, 4);
		}
	}
...
void func_80888860(BgHidanHamstep* pthis, GlobalContext* globalCtx)
{
	...
	if(((pthis->dyna.actor.world.pos.y - pthis->dyna.actor.home.pos.y) < (-20.0f - pthis->dyna.actor.minVelocityY)) && (pthis->dyna.actor.velocity.y <= 0.0f))
	{
		pthis->unk_244++;
...
void func_80888A58(BgHidanHamstep* pthis, GlobalContext* globalCtx)
{
	...
	if(((pthis->dyna.actor.world.pos.y - pthis->dyna.actor.home.pos.y) <= sYPosOffsets[(pthis->dyna.actor.params & 0xFF) - 1]) && (pthis->dyna.actor.velocity.y <= 0.0f))
	{
		pthis->unk_244++;
