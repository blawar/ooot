...
static EnRu2ActionFunc sActionFuncs[] = {
    func_80AF2CB4, func_80AF2CD4, func_80AF2CF4, func_80AF2D2C, func_80AF2D6C, func_80AF2DAC, func_80AF2DEC, func_80AF3144, func_80AF3174, func_80AF31C8,
    func_80AF3604, func_80AF3624, func_80AF366C, func_80AF36AC, func_80AF3BC8, func_80AF3C04, func_80AF3C64, func_80AF3CB8, func_80AF3D0C, func_80AF3D60,
};
...
ActorInit En_Ru2_InitVars = {
    ACTOR_EN_RU2, ACTORCAT_NPC, FLAGS, OBJECT_RU2, ACTOR_FACTORY(EnRu2), (ActorFunc)EnRu2_Init, (ActorFunc)EnRu2_Destroy, (ActorFunc)EnRu2_Update, (ActorFunc)EnRu2_Draw, (ActorFunc)EnRu2_Reset,
};
...
{
	Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_DEMO_6K, pthis->actor.world.pos.x, kREG(19) + 24.0f + pthis->actor.world.pos.y, pthis->actor.world.pos.z, 0, 0, 0, 8);
}
...
void func_80AF321C(EnRu2* pthis, GlobalContext* globalCtx)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_en_ru2_inKenjyanomaDemo02.c", 264);
	...
	CLOSE_DISPS(globalCtx->gfxCtx, "../z_en_ru2_inKenjyanomaDemo02.c", 291);
}
...
void func_80AF3F20(EnRu2* pthis, GlobalContext* globalCtx)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_en_ru2.c", 642);
	...
	CLOSE_DISPS(globalCtx->gfxCtx, "../z_en_ru2.c", 663);
}
