...
void func_808C0C50(BgZg* pthis)
{
	Audio_PlaySoundGeneral(NA_SE_EV_METALDOOR_OPEN, &pthis->dyna.actor.projectedPos, 4, &D_801333E0, &D_801333E0, &gReverbAdd2);
}
...
void func_808C0EEC(BgZg* pthis, GlobalContext* globalCtx)
{
	...
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(localGfxCtx, "../z_bg_zg.c", 315), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
