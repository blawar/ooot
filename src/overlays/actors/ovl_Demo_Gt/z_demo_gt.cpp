...
void DemoGt_SpawnDust(GlobalContext* globalCtx, Vec3f* pos, Vec3f* velocity, Vec3f* accel, f32 scale, s16 scaleStep, s16 life)
{
	func_8002843C(globalCtx, pos, velocity, accel, &brownPrim_33, &redEnv_33, ((Rand_ZeroOne() * (scale * 0.2f)) + scale), scaleStep, life);
}
...
{
	return Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_BG_SPOT16_DOUGHNUT, pos->x, pos->y, pos->z, 0, 0, 0, params);
}
...
void func_8097DAC8(DemoGt* pthis, GlobalContext* globalCtx, Vec3f* spawnerPos)
{
	...
	for(i = 0; i < 12; i++)
	{
		...
		EffectSsKakera_Spawn(globalCtx, &pos, &velocity, spawnerPos, -247, phi_s0, 3, 0, 0, (s32)(Rand_ZeroOne() * 10.0f + 30.0f), 2, 300, (s32)(Rand_ZeroOne() * 0.0f) + 30, KAKERA_COLOR_NONE, OBJECT_GEFF, gGanonRubbleDL);
		angle += 0x1555;
	}
}
...
void func_8097DD28(DemoGt* pthis, GlobalContext* globalCtx, Vec3f* spawnerPos)
{
	...
	for(i = 0; i < 8; i++)
	{
		...
		EffectSsKakera_Spawn(globalCtx, &pos, &velocity, spawnerPos, -247, phi_s0, 3, 0, 0, (s32)((Rand_ZeroOne() * 10.0f) + 30.0f), 2, 300, (s32)(Rand_ZeroOne() * 0.0f) + 0x1E, KAKERA_COLOR_NONE, OBJECT_GEFF, gGanonRubbleDL);
...
void func_8097DF70(DemoGt* pthis, GlobalContext* globalCtx, Vec3f* spawnerPos)
{
	...
	for(i = 0; i < 12; i++)
	{
		...
		EffectSsKakera_Spawn(globalCtx, &pos, &velocity, spawnerPos, -200, phi_s0, 10, 10, 0, Rand_ZeroOne() * 30.0f + 30.0f, 2, 300, (s32)(Rand_ZeroOne() * 30.0f) + 30, KAKERA_COLOR_NONE, OBJECT_GEFF, gGanonRubbleDL);
		angle += 0x1555;
	}
}
...
void func_8097E1D4(GlobalContext* globalCtx, Vec3f* arg1, s16 arg2)
{
	...
	for(i = 0; i < 1; i++)
	{
		...
		EffectSsKakera_Spawn(globalCtx, &pos, &velocity, arg1, -247, phi_s0, 3, 0, 0, (s32)((Rand_ZeroOne() * 10.0f) + 30.0f), 2, 300, (s32)(Rand_ZeroOne() * 0.0f) + 30, KAKERA_COLOR_NONE, OBJECT_GEFF, gGanonRubbleDL);

		angle += 0x10000;
	}
}

void func_8097E454(GlobalContext* globalCtx, Vec3f* spawnerPos, Vec3f* velocity, Vec3f* accel, f32 arg4, f32 scale, s32 arg6, s32 arg7, s16 life)
{
	s32 pad2[3];
	s16 increment;
	s32 frames;
...
void DemoGt_Draw1(DemoGt* pthis, GlobalContext* globalCtx)
{
	...
	gSPSegment(POLY_OPA_DISP++, 0x08, Gfx_TwoTexScrollEnvColor(gfxCtx, 0, 0, unk198[0], 0x20, 0x40, 1, 0, unk198[1], 0x20, 0x40, unk178[0], unk178[1], unk178[2], 0x80));
	gSPSegment(POLY_OPA_DISP++, 0x0A, Gfx_TwoTexScrollEnvColor(gfxCtx, 0, 0, unk198[0], 0x20, 0x40, 1, 0, unk198[1], 0x20, 0x40, unk188[0], unk188[1], unk188[2], 0x80));
	...
	gSPSegment(POLY_XLU_DISP++, 0x09, Gfx_TwoTexScroll(gfxCtx, 0, 0, gameplayFrames * 0x14, 0x10, 0x200, 1, 0, gameplayFrames * 0x1E, 0x10, 0x200));
...
void DemoGt_Draw2(DemoGt* pthis, GlobalContext* globalCtx)
{
	...
	unk198 = pthis->unk_198;
	unk178 = pthis->unk_178;
	gSPSegment(POLY_OPA_DISP++, 0x08, Gfx_TwoTexScrollEnvColor(gfxCtx, 0, 0, unk198[0], 0x20, 0x40, 1, 0, unk198[1], 0x20, 0x40, unk178[0], unk178[1], unk178[2], 128));
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(gfxCtx, "../z_demo_gt_part2.c", 485), G_MTX_PUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
...
void DemoGt_Draw3(DemoGt* pthis, GlobalContext* globalCtx)
{
	...
	func_80093D18(gfxCtx);
	gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(gfxCtx, "../z_demo_gt_part3.c", 1028), G_MTX_PUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
...
static DemoGtUpdateFunc sUpdateFuncs[] = {
    DemoGt_Update0,  DemoGt_Update1,  DemoGt_Update2,  DemoGt_Update3,	DemoGt_Update4,	 DemoGt_Update5,  DemoGt_Update6,  DemoGt_Update7,  DemoGt_Update8,  DemoGt_Update9,
    DemoGt_Update10, DemoGt_Update11, DemoGt_Update12, DemoGt_Update13, DemoGt_Update14, DemoGt_Update15, DemoGt_Update16, DemoGt_Update17, DemoGt_Update18,
};
...
static DemoGtDrawFunc sDrawFuncs[] = {
    DemoGt_Draw0, DemoGt_Draw1, DemoGt_Draw2, DemoGt_Draw3, DemoGt_Draw4, DemoGt_Draw5, DemoGt_Draw6, DemoGt_Draw7, DemoGt_Draw8,
};
