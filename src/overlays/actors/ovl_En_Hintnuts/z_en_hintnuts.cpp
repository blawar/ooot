...
void EnHintnuts_Wait(EnHintnuts* pthis, GlobalContext* globalCtx)
{
	...
	pthis->collider.dim.height = 5.0f + ((pthis->skelAnime.curFrame.clamp(9.0f, 12.0f) - 9.0f) * 9.0f);
...
void EnHintnuts_Burrow(EnHintnuts* pthis, GlobalContext* globalCtx)
{
	...
	{
		pthis->collider.dim.height = 5.0f + ((3.0f - pthis->skelAnime.curFrame.clamp(1.0f, 3.0f)) * 12.0f);
	}
