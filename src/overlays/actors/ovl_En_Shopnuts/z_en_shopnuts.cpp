...
void EnShopnuts_Wait(EnShopnuts* pthis, GlobalContext* globalCtx)
{
	...
	pthis->collider.dim.height = ((pthis->skelAnime.curFrame.clamp(9.0f, 13.0f) - 9.0f) * 9.0f) + 5.0f;
...
void EnShopnuts_Burrow(EnShopnuts* pthis, GlobalContext* globalCtx)
{
	...
	{
		pthis->collider.dim.height = ((4.0f - pthis->skelAnime.curFrame.clampMax(4.0f)) * 10.0f) + 5.0f;
	}
