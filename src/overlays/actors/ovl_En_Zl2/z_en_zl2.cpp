...
static void* sEyeTextures[] = {gZelda2EyeOpenTex, gZelda2EyeHalfTex, gZelda2EyeShutTex, gZelda2Eye03Tex, gZelda2Eye04Tex, gZelda2Eye05Tex, gZelda2Eye06Tex, gZelda2Eye07Tex, gZelda2Eye08Tex};
...
static EnZl2ActionFunc sActionFuncs[] = {
    func_80B521A0, func_80B50BBC, func_80B50BEC, func_80B50C40, func_80B50CA8, func_80B50CFC, func_80B50D50, func_80B50D94, func_80B50DE8, func_80B50E3C, func_80B50E90, func_80B50EE4,
    func_80B50F38, func_80B50F8C, func_80B50FE8, func_80B51034, func_80B51080, func_80B510CC, func_80B51118, func_80B51164, func_80B511B0, func_80B511FC, func_80B51250, func_80B512B8,
    func_80B51310, func_80B51A5C, func_80B51A8C, func_80B51AE4, func_80B51B44, func_80B51BA8, func_80B51C0C, func_80B51C64, func_80B51CA8, func_80B52068, func_80B52098, func_80B52108,
};
...
void func_80B4EE38(EnZl2* pthis, s16 arg1, s32 arg2)
{
	...
	if(pthis->unk_24C != 0)
	{
		...
		temp_v1 += phi_v0;
		if(((pthis->unk_1AC[arg2] * phi_v0) <= 0) && ((s16)(temp_v1 - arg1) > -0x64) && ((s16)(temp_v1 - arg1) < 0x64))
		{
			temp_v1 = arg1;
			phi_v0 = 0;
		}
...
void func_80B4EF64(EnZl2* pthis, s16 arg1, s32 arg2)
{
	...
	if(pthis->unk_24C != 0)
	{
		...
		if(((pthis->unk_1AC[arg2] * phi_v0) <= 0) && ((s16)(temp_v1 - phi_a0) > -0x64) && ((s16)(temp_v1 - phi_a0) < 0x64))
		{
			temp_v1 = phi_a0;
			phi_v0 = 0;
		}
...
s32 func_80B4F45C(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx, Gfx** gfx)
{
	...
	if(limbIndex == 14)
	{
		sp74 = (Mtx*)Graph_Alloc(globalCtx->gfxCtx, sizeof(Mtx) * 7);
	...
	if(limbIndex == 10)
	{
...

		{
			...
			if(player->rightHandType == 0xFF)
			{
				...
				gSPMatrix((*gfx)++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_en_zl2.c", 1253), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
				gSPDisplayList((*gfx)++, gZelda2OcarinaDL);
			}
			Matrix_Pop();
		}
...
void func_80B501E8(EnZl2* pthis, GlobalContext* globalCtx)
{
	...
	if(npcAction != NULL)
	{
		pthis->actor.shape.shadowAlpha = pthis->alpha = (1.0f - Environment_LerpWeight(npcAction->endFrame, npcAction->startFrame, globalCtx->csCtx.frames)) * 255.0f;
...
s32 EnZl2_OverrideLimbDraw(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx, Gfx** gfx)
{
	EnZl2* pthis = (EnZl2*)thisx;

	if(pthis->overrideLimbDrawConfig < 0 || pthis->overrideLimbDrawConfig > 0 || sOverrideLimbDrawFuncs[pthis->overrideLimbDrawConfig] == NULL)
	{
...
void func_80B523C8(EnZl2* pthis, GlobalContext* globalCtx)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_en_zl2.c", 1623);
	...
	POLY_OPA_DISP = SkelAnime_DrawFlex(globalCtx, skelAnime->skeleton, skelAnime->jointTable, skelAnime->dListCount, EnZl2_OverrideLimbDraw, EnZl2_PostLimbDraw, pthis, POLY_OPA_DISP);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_en_zl2.c", 1648);
}
...
void func_80B525D4(EnZl2* pthis, GlobalContext* globalCtx)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_en_zl2.c", 1663);
	...
	POLY_XLU_DISP = SkelAnime_DrawFlex(globalCtx, skelAnime->skeleton, skelAnime->jointTable, skelAnime->dListCount, EnZl2_OverrideLimbDraw, NULL, pthis, POLY_XLU_DISP);

	CLOSE_DISPS(globalCtx->gfxCtx, "../z_en_zl2.c", 1692);
}
