...
static InitChainEntry sInitChain1[] = {
    ICHAIN_F32(minVelocityY, -10, ICHAIN_CONTINUE), ICHAIN_F32(gravity, -4, ICHAIN_CONTINUE), ICHAIN_F32(uncullZoneForward, 1400, ICHAIN_CONTINUE), ICHAIN_F32(uncullZoneScale, 500, ICHAIN_CONTINUE), ICHAIN_F32(uncullZoneDownward, 800, ICHAIN_STOP),
};
...
{
	if((D_808B913C[pthis->dyna.actor.params & 0xF] != NULL) && (!D_808B913C[pthis->dyna.actor.params & 0xF](pthis, globalCtx)))
	{
		return 0;
	}
	return 1;
...
void func_808B8F08(BgSpot18Obj* pthis, GlobalContext* globalCtx)
{
	...
	if(Math3D_Dist2DSq(pthis->dyna.actor.world.pos.x, pthis->dyna.actor.world.pos.z, pthis->dyna.actor.home.pos.x, pthis->dyna.actor.home.pos.z) >= 6400.0f)
	{
		func_808B9030(pthis);
		pthis->dyna.actor.world.pos.x = (Math_SinS(pthis->dyna.actor.world.rot.y) * 80.0f) + pthis->dyna.actor.home.pos.x;
		pthis->dyna.actor.world.pos.z = (Math_CosS(pthis->dyna.actor.world.rot.y) * 80.0f) + pthis->dyna.actor.home.pos.z;
