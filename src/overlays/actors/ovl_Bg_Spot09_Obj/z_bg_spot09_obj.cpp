...
ActorInit Bg_Spot09_Obj_InitVars = {
    ACTOR_BG_SPOT09_OBJ, ACTORCAT_BG, FLAGS, OBJECT_SPOT09_OBJ, ACTOR_FACTORY(BgSpot09Obj), (ActorFunc)BgSpot09Obj_Init, (ActorFunc)BgSpot09Obj_Destroy, (ActorFunc)BgSpot09Obj_Update, (ActorFunc)BgSpot09Obj_Draw, (ActorFunc)BgSpot09Obj_Reset,
};
...
void BgSpot09Obj_Draw(Actor* thisx, GlobalContext* globalCtx)
{
	...
	if(thisx->params == 3)
	{
		OPEN_DISPS(globalCtx->gfxCtx, "../z_bg_spot09_obj.c", 388);

		func_80093D84(globalCtx->gfxCtx);

		gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_bg_spot09_obj.c", 391), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
		gSPDisplayList(POLY_XLU_DISP++, gCarpentersTentEntranceDL);

		CLOSE_DISPS(globalCtx->gfxCtx, "../z_bg_spot09_obj.c", 396);
	}
}
