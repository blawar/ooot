...
void EnToryo_Init(Actor* thisx, GlobalContext* globalCtx)
{
	...
	SkelAnime_InitFlex(globalCtx, &pthis->skelAnime, &object_toryo_Skel_007150, NULL, pthis->jointTable, pthis->morphTable, 17);
	...
	Animation_Change(&pthis->skelAnime, sEnToryoAnimation.anim, 1.0f, 0.0f, Animation_GetLastFrame(sEnToryoAnimation.anim), sEnToryoAnimation.mode, sEnToryoAnimation.transitionRate);
	pthis->stateFlags |= 8;
