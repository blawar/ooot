...
void func_80A91620(EnKakasi3* pthis, GlobalContext* globalCtx)
{
	...
	if((globalCtx->msgCtx.ocarinaMode == OCARINA_MODE_04 || (globalCtx->msgCtx.ocarinaMode >= OCARINA_MODE_05 && globalCtx->msgCtx.ocarinaMode < OCARINA_MODE_0B)) && (globalCtx->msgCtx.msgMode == MSGMODE_NONE))
	{
