...
ActorInit Bg_Hidan_Hrock_InitVars = {
    ACTOR_BG_HIDAN_HROCK, ACTORCAT_BG, FLAGS, OBJECT_HIDAN_OBJECTS, ACTOR_FACTORY(BgHidanHrock), (ActorFunc)BgHidanHrock_Init, (ActorFunc)BgHidanHrock_Destroy, (ActorFunc)BgHidanHrock_Update, (ActorFunc)BgHidanHrock_Draw, (ActorFunc)BgHidanHrock_Reset,
};
...
void func_808894B0(BgHidanHrock* pthis, GlobalContext* globalCtx)
{
	...
	pthis->dyna.actor.world.pos.x = (Math_SinS(pthis->dyna.actor.world.rot.y + (pthis->unk_168 << 0xE)) * 5.0f) + pthis->dyna.actor.home.pos.x;
	pthis->dyna.actor.world.pos.z = (Math_CosS(pthis->dyna.actor.world.rot.y + (pthis->unk_168 << 0xE)) * 5.0f) + pthis->dyna.actor.home.pos.z;
