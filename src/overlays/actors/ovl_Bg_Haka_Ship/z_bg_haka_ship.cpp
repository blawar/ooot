...
void BgHakaShip_Init(Actor* thisx, GlobalContext* globalCtx)
{
	...
	pthis->yOffset = 0;
	if(pthis->dyna.actor.params == 0 &&
	   Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->dyna.actor, globalCtx, ACTOR_BG_HAKA_SHIP, pthis->dyna.actor.world.pos.x + -10.0f, pthis->dyna.actor.world.pos.y + 82.0f, pthis->dyna.actor.world.pos.z, 0, 0, 0, 1) == NULL)
	{
