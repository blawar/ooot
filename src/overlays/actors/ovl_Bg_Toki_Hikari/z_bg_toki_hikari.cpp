...
void func_808BA2CC(BgTokiHikari* pthis, GlobalContext* globalCtx) {
    ...
    gDPSetPrimColor(POLY_XLU_DISP++, 0, 0x80, pthis->unk_14C * 255.0f, (u8)(155.0f * pthis->unk_14C) + 100,
                    pthis->unk_14C * 255.0f, pthis->unk_14C * 255.0f);
    ...
    gDPSetEnvColor(POLY_XLU_DISP++, (u8)(pthis->unk_14C * 255.0f), (u8)(pthis->unk_14C * 255.0f),
                   (u8)(pthis->unk_14C * 255.0f), (u8)(200.0f * pthis->unk_14C));
