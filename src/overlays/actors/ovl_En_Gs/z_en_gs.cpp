...
void func_80A4E470(EnGs* pthis, GlobalContext* globalCtx)
{
	...
	if(pthis->actor.xzDistToPlayer <= 100.0f)
	{
		...
		else if(pthis->unk_19D & 1)
		{
			...
			{
				if((globalCtx->msgCtx.unk_E3F2 == OCARINA_SONG_SARIAS) || (globalCtx->msgCtx.unk_E3F2 == OCARINA_SONG_EPONAS) || (globalCtx->msgCtx.unk_E3F2 == OCARINA_SONG_LULLABY) || (globalCtx->msgCtx.unk_E3F2 == OCARINA_SONG_SUNS) ||
				   (globalCtx->msgCtx.unk_E3F2 == OCARINA_SONG_TIME))
				{
					Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_EN_ELF, pthis->actor.world.pos.x, pthis->actor.world.pos.y + 40.0f, pthis->actor.world.pos.z, 0, 0, 0, FAIRY_HEAL_TIMED);
					Audio_PlayActorSound2(&pthis->actor, NA_SE_EV_BUTTERFRY_TO_FAIRY);
				}
				else if(globalCtx->msgCtx.unk_E3F2 == OCARINA_SONG_STORMS)
				{
					Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_EN_ELF, pthis->actor.world.pos.x, pthis->actor.world.pos.y + 40.0f, pthis->actor.world.pos.z, 0, 0, 0, FAIRY_HEAL_BIG);
					Audio_PlayActorSound2(&pthis->actor, NA_SE_EV_BUTTERFRY_TO_FAIRY);
				}
				pthis->unk_19D = 0;
...
f32 func_80A4E754(EnGs* pthis, GlobalContext* globalCtx, f32* arg2, f32* arg3, u16* arg4, f32 arg5, f32 arg6, f32 arg7, s32 arg8, s32 arg9)
{
...
void func_80A4E910(EnGs* pthis, GlobalContext* globalCtx)
{
	...
	else if((pthis->unk_19F == 1) && (func_80A4E754(pthis, globalCtx, &pthis->unk_1E8, &pthis->unk_1EC, &pthis->unk_200, 0.8f, 0.007f, 0.001f, 7, 0) == 0.0f))
	{
...
void func_80A4EA08(EnGs* pthis, GlobalContext* globalCtx)
{
	...
	else if(pthis->unk_19F == 1)
	{
		...
		if(func_80A4E754(pthis, globalCtx, &pthis->unk_1E8, &pthis->unk_1EC, &pthis->unk_200, 0.8f, 0.005f, 0.001f, 7, 0) == 0.0f)
		{
			pthis->unk_19C = 0;
			pthis->actionFunc = func_80A4F734;
		}
...
void func_80A4EB3C(EnGs* pthis, GlobalContext* globalCtx)
{
	...
	{
		if(func_80A4E754(pthis, globalCtx, &pthis->unk_1E8, &pthis->unk_1EC, &pthis->unk_200, 1.0f, 0.03f, 0.001f, 5, 0) == 0.0f)
		{
			pthis->unk_19C = 0;
			pthis->actionFunc = func_80A4F734;
		}
...
void func_80A4ED34(EnGs* pthis, GlobalContext* globalCtx)
{
	...
	if(pthis->unk_19F == 3)
	{
		for(i = 0; i < 3; i++)
		{
			...
			func_8002836C(globalCtx, &dustPos, &dustVelocity, &dustAccel_42, &dustPrim_42, &dustEnv_42, (s16)Rand_ZeroFloat(50.0f) + 200, 40, 15);
		}
...
void EnGs_Draw(Actor* thisx, GlobalContext* globalCtx)
{
	...
	if(!(pthis->unk_19E & 8))
	{
		...
		if(pthis->unk_19E & 4)
		{
			gDPSetPrimColor(POLY_OPA_DISP++, 0, 0, pthis->flashColor.r, pthis->flashColor.g, pthis->flashColor.b, pthis->flashColor.a);
		}
		else
		{
