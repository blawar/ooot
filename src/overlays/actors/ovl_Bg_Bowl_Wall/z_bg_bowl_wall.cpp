...
void BgBowlWall_SpawnBullseyes(BgBowlWall* pthis, GlobalContext* globalCtx)
{
	...
	bullseye = (EnWallTubo*)Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->dyna.actor, globalCtx, ACTOR_EN_WALL_TUBO, pthis->bullseyeCenter.x, pthis->bullseyeCenter.y, pthis->bullseyeCenter.z, 0, 0, 0, pthis->dyna.actor.params);
	if(bullseye != NULL)
	{
