...
void func_808B3420(BgSpot12Saku* pthis, GlobalContext* globalCtx, CollisionHeader* collision, s32 flags)
{
	...
	{
		osSyncPrintf("Warning : move BG 登録失敗(%s %d)(name %d)(arg_data 0x%04x)\n", "../z_bg_spot12_saku.c", 140, pthis->dyna.actor.id, pthis->dyna.actor.params);
	}
}
...
void func_808B3604(BgSpot12Saku* pthis, GlobalContext* globalCtx)
{
	...
	pthis->dyna.actor.world.pos.x = pthis->dyna.actor.home.pos.x - (Math_SinS(pthis->dyna.actor.shape.rot.y + 0x4000) * temp_f18);
	pthis->dyna.actor.world.pos.z = pthis->dyna.actor.home.pos.z - (Math_CosS(pthis->dyna.actor.shape.rot.y + 0x4000) * temp_f18);
...
void func_808B3714(BgSpot12Saku* pthis)
{
	...
	pthis->dyna.actor.world.pos.x = pthis->dyna.actor.home.pos.x - (Math_SinS(pthis->dyna.actor.shape.rot.y + 0x4000) * 78.0f);
	pthis->dyna.actor.world.pos.z = pthis->dyna.actor.home.pos.z - (Math_CosS(pthis->dyna.actor.shape.rot.y + 0x4000) * 78.0f);
}
