    {0x0010, 0x001E, 0x0032, 0x003C, 0x0096, 0x00C8, 0x0006}, {0x0011, 0x000A, 0x000A, 0x0000, 0x0082, 0x00DC, 0x0006}, {0x0012, 0x000A, 0x0028, 0x0014, 0x00B4, 0x00DC, 0x000B}, {0x0013, 0x000A, 0x0005, 0x0000, 0x006E, 0x0046, 0x0011},
    {0x0013, 0xFFEC, 0x0032, 0xFFE2, 0x0096, 0x00C8, 0x0006}, {0x0014, 0x0050, 0x0032, 0x0000, 0x0096, 0x00C8, 0x0008},
};
...
static InitChainEntry sInitChainDebris[] = {
    ICHAIN_F32(gravity, -1, ICHAIN_CONTINUE), ICHAIN_F32(minVelocityY, -10, ICHAIN_CONTINUE), ICHAIN_F32(uncullZoneForward, 1000, ICHAIN_CONTINUE), ICHAIN_F32(uncullZoneScale, 200, ICHAIN_CONTINUE), ICHAIN_F32(uncullZoneDownward, 1000, ICHAIN_STOP),
};
...
void func_808B5240(BgSpot16Bombstone* pthis, GlobalContext* globalCtx)
{
	...
	while(true)
	{
		...
		func_800287AC(globalCtx, &position, &sVelocity, &sAcceleration, D_808B5EB0[index][4], D_808B5EB0[index][5], D_808B5EB0[index][6]);
...
void BgSpot16Bombstone_SpawnFragments(BgSpot16Bombstone* pthis, GlobalContext* globalCtx)
{
	...
	{
		Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_BG_SPOT16_BOMBSTONE, pthis->actor.world.pos.x, pthis->actor.world.pos.y, pthis->actor.world.pos.z, 0, 0, 0, 5);
		index = 3;
	}
	else
	{
	...
	if(index < ARRAY_COUNT(sBombSizeScalers))
	{
		do
		{
			...
			EffectSsKakera_Spawn(globalCtx, &pos, &velocity, &pthis->actor.world.pos, -420, 0x31, 0xF, 0xF, 0, scale, 2, 0x40, 160, KAKERA_COLOR_NONE, OBJECT_BOMBIWA, object_bombiwa_DL_0009E0);
			index += 1;
...
void func_808B561C(BgSpot16Bombstone* pthis, GlobalContext* globalCtx)
{
	...
	{
		if(Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_BG_SPOT16_BOMBSTONE, world->pos.x, world->pos.y, world->pos.z, 0, 0, 0, sActorSpawnParams[index]) == NULL)
		{
			break;
		}
	}
...
void func_808B56BC(BgSpot16Bombstone* pthis, GlobalContext* globalCtx)
{
	...
	if(pthis->actor.xzDistToPlayer < 130.0f && pthis->actor.yDistToPlayer < 160.0f && pthis->actor.yDistToPlayer >= -10.0f)
	{
...
void func_808B57E0(BgSpot16Bombstone* pthis, GlobalContext* globalCtx)
{
	...
	if(sPlayerBomb != NULL)
	{
		...
		else if(sTimer <= 0 && sPlayerBomb->actor.world.pos.y < 1400.0f && Math3D_Dist1DSq(sPlayerBomb->actor.world.pos.x + 1579.0f, sPlayerBomb->actor.world.pos.z + 790.0f) < SQ(400.0f) && sPlayerBomb->actor.params == 0)
		{
	...
	else if(player->stateFlags1 & PLAYER_STATE1_11)
	{
		...
		if(playerHeldActor != NULL && playerHeldActor->category == ACTORCAT_EXPLOSIVE && playerHeldActor->id == ACTOR_EN_BOMBF)
		{
