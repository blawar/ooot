...
void func_80B93B68(ObjHsblock* pthis, GlobalContext* globalCtx, CollisionHeader* collision, s32 moveFlags)
{
	...
	{
		osSyncPrintf("Warning : move BG 登録失敗(%s %d)(name %d)(arg_data 0x%04x)\n", "../z_obj_hsblock.c", 163, pthis->dyna.actor.id, pthis->dyna.actor.params);
	}
}
...
void func_80B93BF0(ObjHsblock* pthis, GlobalContext* globalCtx)
{
	...
	{
		Actor_SpawnAsChild(
		    &globalCtx->actorCtx, &pthis->dyna.actor, globalCtx, ACTOR_OBJ_ICE_POLY, pthis->dyna.actor.world.pos.x, pthis->dyna.actor.world.pos.y, pthis->dyna.actor.world.pos.z, pthis->dyna.actor.world.rot.x, pthis->dyna.actor.world.rot.y,
		    pthis->dyna.actor.world.rot.z, 1);
	}
}
...
void func_80B93E5C(ObjHsblock* pthis, GlobalContext* globalCtx)
{
	...
	if(fabsf(Math_SmoothStepToF(&pthis->dyna.actor.world.pos.y, pthis->dyna.actor.home.pos.y, 0.3f, pthis->dyna.actor.velocity.y, 0.3f)) < 0.001f)
	{
