...
static void* sEyeTextures[] = {
    oot::asset::texture::load(symbol::object_ganon2_Tex_01E188),
    oot::asset::texture::load(symbol::object_ganon2_Tex_01E988),
    oot::asset::texture::load(symbol::object_ganon2_Tex_01EA08),
};
