	...
	if(!Flags_GetClear(globalCtx, globalCtx->roomCtx.curRoom.num))
	{
		...
		if(bossFd->platformSignal != VBSIMA_STAND)
		{
			...
			for(i1 = 0; i1 < 10; i1++)
			{
				...
				func_8002836C(globalCtx, &splashPos, &splashVel, &splashAcc, &colorYellow_27, &colorRed_27, (s16)Rand_ZeroFloat(100.0f) + 500, 10, 20);
				...
				for(i2 = 0; i2 < 3; i2++)
				{
					...
					BgVbSima_SpawnEmber(bossFd->effects, &emberPos, &emberVel, &emberAcc, (s16)Rand_ZeroFloat(2.0f) + 8);
				}
			}
		}
	}
