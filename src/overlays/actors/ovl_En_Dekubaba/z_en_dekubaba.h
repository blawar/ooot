...
struct EnDekubaba
{
	...
	/* 0x01C4 */ char pad[0x2];
	/* 0x01C6 */ Timer timer;
	/* 0x01C8 */ Rotation targetSwayAngle;
	/* 0x01CA */ Rotation stemSectionAngle[3]; // Used to calculate the position of the stem sections and head with spherical trigonometry
