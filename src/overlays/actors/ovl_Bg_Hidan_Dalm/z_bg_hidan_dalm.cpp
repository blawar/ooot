...
void BgHidanDalm_Wait(BgHidanDalm* pthis, GlobalContext* globalCtx)
{
	...
	if((pthis->collider.base.acFlags & AC_HIT) && !Player_InCsMode(globalCtx) && (player->swordAnimation == 22 || player->swordAnimation == 23))
	{
		pthis->collider.base.acFlags &= ~AC_HIT;
		if((pthis->collider.elements[0].info.bumperFlags & BUMP_HIT) || (pthis->collider.elements[1].info.bumperFlags & BUMP_HIT))
		{
