...
void EnMu_Update(Actor* thisx, GlobalContext* globalCtx)
{
	...
	func_800343CC(globalCtx, &pthis->actor, &pthis->npcInfo.unk_00, talkDist, EnMu_GetFaceReaction, EnMu_CheckDialogState);
...
s32 EnMu_OverrideLimbDraw(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx)
{
	...
	if((limbIndex == 5) || (limbIndex == 6) || (limbIndex == 7) || (limbIndex == 11) || (limbIndex == 12) || (limbIndex == 13) || (limbIndex == 14))
	{
...
{
	EnMu* pthis = (EnMu*)thisx;
	Color_RGBA8 colors[2][5] = {{{100, 130, 235, 0}, {160, 250, 60, 0}, {90, 60, 20, 0}, {30, 240, 200, 0}, {140, 70, 20, 0}}, {{140, 70, 20, 0}, {30, 240, 200, 0}, {90, 60, 20, 0}, {160, 250, 60, 0}, {100, 130, 235, 0}}};
