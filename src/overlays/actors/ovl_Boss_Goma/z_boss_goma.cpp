...
static f32 colors1_185[][3] = {
    {255.0f, 17.0f, 0.0f}, {0.0f, 255.0f, 170.0f}, {50.0f, 50.0f, 50.0f}, {0.0f, 255.0f, 170.0f}, {0.0f, 255.0f, 170.0f}, {0.0f, 255.0f, 170.0f},
};

static f32 colors2_185[][3] = {
    {255.0f, 17.0f, 0.0f}, {0.0f, 255.0f, 170.0f}, {50.0f, 50.0f, 50.0f}, {0.0f, 255.0f, 170.0f}, {0.0f, 0.0f, 255.0f}, {255.0f, 17.0f, 0.0f},
};

static f32 targetEyeEnvColors_186[][3] = {
    {255.0f, 17.0f, 0.0f}, {255.0f, 255.0f, 255.0f}, {50.0f, 50.0f, 50.0f}, {0.0f, 255.0f, 170.0f}, {0.0f, 255.0f, 170.0f}, {0.0f, 255.0f, 170.0f},
};
...
static u8 sClearPixelTableFirstPass[16 * 16] = {};

static u8 sClearPixelTableSecondPass[16 * 16] = {0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
						 ...
						 ,
...
void BossGoma_Init(Actor* thisx, GlobalContext* globalCtx)
{
	...
	if(Flags_GetClear(globalCtx, globalCtx->roomCtx.curRoom.num))
	{
		...
		Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_DOOR_WARP1, 0.0f, -640.0f, 0.0f, 0, 0, 0, WARP_DUNGEON_CHILD);
...
void BossGoma_PlayEffectsAndSfx(BossGoma* pthis, GlobalContext* globalCtx, s16 arg2, s16 amountMinus1)
{
	...
	{
		Actor_SpawnFloorDustRing(globalCtx, &pthis->actor, &pthis->rightHandBackLimbWorldPos, 25.0f, amountMinus1, 8.0f, 500, 10, 1);
	}

	if(arg2 == 0 || arg2 == 2 || arg2 == 3)
	{
		Actor_SpawnFloorDustRing(globalCtx, &pthis->actor, &pthis->leftHandBackLimbWorldPos, 25.0f, amountMinus1, 8.0f, 500, 10, 1);
	}
...
{
	Animation_Change(&pthis->skelanime, &gGohmaDeathAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaDeathAnim), ANIMMODE_ONCE, -2.0f);
...
{
	pthis->framesUntilNextAction = Rand_S16Offset(20, 30);
	Animation_Change(&pthis->skelanime, &gGohmaHangAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaHangAnim), ANIMMODE_LOOP, -5.0f);
...
{
	Animation_Change(&pthis->skelanime, &gGohmaLayEggsAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaLayEggsAnim), ANIMMODE_LOOP, -15.0f);
...
{
	Animation_Change(&pthis->skelanime, &gGohmaPrepareEggsAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaPrepareEggsAnim), ANIMMODE_LOOP, -10.0f);
...
{
	Animation_Change(&pthis->skelanime, &gGohmaClimbAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaClimbAnim), ANIMMODE_LOOP, -10.0f);
...
{
	Animation_Change(&pthis->skelanime, &gGohmaWalkAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaWalkAnim), ANIMMODE_LOOP, -5.0f);
...
{
	Animation_Change(&pthis->skelanime, &gGohmaWalkCrouchedAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaWalkCrouchedAnim), ANIMMODE_LOOP, -5.0f);
...
{
	Animation_Change(&pthis->skelanime, &gGohmaLandAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaLandAnim), ANIMMODE_ONCE, -2.0f);
...
{
	Animation_Change(&pthis->skelanime, &gGohmaCrashAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaCrashAnim), ANIMMODE_ONCE, -2.0f);
...
{
	Animation_Change(&pthis->skelanime, &gGohmaStunnedAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaStunnedAnim), ANIMMODE_LOOP, -2.0f);
...
{
	Animation_Change(&pthis->skelanime, &gGohmaPrepareAttackAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaPrepareAttackAnim), ANIMMODE_ONCE, -10.0f);
...
{
	Animation_Change(&pthis->skelanime, &gGohmaStandAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaStandAnim), ANIMMODE_LOOP, -10.0f);
...
{
	Animation_Change(&pthis->skelanime, &gGohmaAttackAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaAttackAnim), ANIMMODE_ONCE, -10.0f);
...
{
	Animation_Change(&pthis->skelanime, &gGohmaDamageAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaDamageAnim), ANIMMODE_ONCE, -2.0f);
	pthis->actionFunc = BossGoma_FloorDamaged;
}

void BossGoma_UpdateCeilingMovement(BossGoma* pthis, GlobalContext* globalCtx, f32 dz, f32 targetSpeedXZ, s16 rotateTowardsCenter)
{
	Vec3f* basePos = NULL;
	s16 i;
	Vec3f vel;
	...
	{
		Math_ApproachS(&pthis->actor.world.rot.y, Math_Vec3f_Yaw(&pthis->actor.world.pos, &roomCenter_122) + 0x8000, 3, 0x3E8);
	}
...
void BossGoma_SetupEncounterState4(BossGoma* pthis, GlobalContext* globalCtx)
{
	...
	Animation_Change(&pthis->skelanime, &gGohmaEyeRollAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaEyeRollAnim), ANIMMODE_ONCE, 0.0f);
...
void BossGoma_Encounter(BossGoma* pthis, GlobalContext* globalCtx)
{
	...
	switch(pthis->actionState)
	{
		case 0: // wait for the player to enter the room
			...
			if(fabsf(player->actor.world.pos.x - 150.0f) < 60.0f && fabsf(player->actor.world.pos.z - 350.0f) < 60.0f)
			{
				if(gSaveContext.eventChkInf[7] & 1)
				{
					BossGoma_SetupEncounterState4(pthis, globalCtx);
					Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_DOOR_SHUTTER, 164.72f, -480.0f, 397.68002f, 0, -0x705C, 0, 0x180);
				}
				else
				{
		...
		case 2: // zoom on player from room center
			...
			if(pthis->framesUntilNextAction == 0)
			{
				...
				Math_ApproachF(&pthis->subCameraEye.x, player->actor.world.pos.x - 20.0f, 0.049999997f, pthis->subCameraFollowSpeed * 50.0f);
				Math_ApproachF(&pthis->subCameraEye.y, player->actor.world.pos.y + 25.0f, 0.099999994f, pthis->subCameraFollowSpeed * 130.0f);
				Math_ApproachF(&pthis->subCameraEye.z, player->actor.world.pos.z - 65.0f, 0.049999997f, pthis->subCameraFollowSpeed * 30.0f);
				Math_ApproachF(&pthis->subCameraFollowSpeed, 0.29999998f, 1.0f, 0.0050000004f);
				if(pthis->timer == 0)
				{
					Math_ApproachF(&pthis->subCameraAt.y, player->actor.world.pos.y + 35.0f, 0.099999994f, pthis->subCameraFollowSpeed * 30.0f);
				}
				pthis->subCameraAt.x = player->actor.world.pos.x;
				pthis->subCameraAt.z = player->actor.world.pos.z;
			}
			...
			{
				Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_DOOR_SHUTTER, 164.72f, -480.0f, 397.68002f, 0, -0x705C, 0, SHUTTER_GOHMA_BLOCK << 6);
			}
		...
		case 3: // wait for the player to look at Gohma
			if(fabsf(pthis->actor.projectedPos.x) < 150.0f && fabsf(pthis->actor.projectedPos.y) < 250.0f && pthis->actor.projectedPos.z < 800.0f && pthis->actor.projectedPos.z > 0.0f)
			{
				pthis->lookedAtFrames++;
				Math_ApproachZeroF(&pthis->actor.speedXZ, 0.5f, 2.0f);
				Math_ApproachS(&pthis->actor.world.rot.y, Actor_WorldYawTowardActor(&pthis->actor, &GET_PLAYER(globalCtx)->actor) + 0x8000, 2, 0xBB8);
		...
		case 4: // focus Gohma on the ceiling
			...
			if(pthis->framesUntilNextAction <= 40)
			{
				...
				if(pthis->framesUntilNextAction < 20)
				{
					...
					{
						pthis->actionState = 5;
						Animation_Change(&pthis->skelanime, &gGohmaWalkAnim, 2.0f, 0.0f, Animation_GetLastFrame(&gGohmaWalkAnim), ANIMMODE_LOOP, -5.0f);
		...
		case 5: // running on the ceiling
			...
			Math_ApproachF(&pthis->subCameraEye.x, pthis->actor.world.pos.x + 8.0f + 90.0f, 0.1f, pthis->subCameraFollowSpeed * 30.0f);
			Math_ApproachF(&pthis->subCameraEye.y, player->actor.world.pos.y, 0.1f, pthis->subCameraFollowSpeed * 30.0f);
			Math_ApproachF(&pthis->subCameraEye.z, pthis->actor.world.pos.z + 45.0f + 40.0f, 0.1f, pthis->subCameraFollowSpeed * 30.0f);
			...
			if(pthis->framesUntilNextAction == 0)
			{
				...
				pthis->actor.velocity.y = 0.0f;
				pthis->actor.gravity = -2.0f;
				Animation_Change(&pthis->skelanime, &gGohmaInitialLandingAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaInitialLandingAnim), ANIMMODE_ONCE, -5.0f);
		...
		case 9: // falling from the ceiling
			Math_ApproachF(&pthis->subCameraEye.x, pthis->actor.world.pos.x + 8.0f + 90.0f, 0.1f, pthis->subCameraFollowSpeed * 30.0f);
			Math_ApproachF(&pthis->subCameraEye.y, player->actor.world.pos.y + 10.0f, 0.1f, pthis->subCameraFollowSpeed * 30.0f);
			Math_ApproachF(&pthis->subCameraEye.z, pthis->actor.world.pos.z + 45.0f + 40.0f, 0.1f, pthis->subCameraFollowSpeed * 30.0f);
			pthis->subCameraAt.x = pthis->actor.world.pos.x;
			pthis->subCameraAt.y = pthis->actor.world.pos.y;
			pthis->subCameraAt.z = pthis->actor.world.pos.z;
			...
			if(pthis->actor.bgCheckFlags & BG_STATE_0)
			{
				...
				pthis->actor.velocity.y = 0.0f;
				Animation_Change(&pthis->skelanime, &gGohmaInitialLandingAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaInitialLandingAnim), ANIMMODE_ONCE, -2.0f);
		...
		case 130: // focus Gohma on the ground
			...
			if(Animation_OnFrame(&pthis->skelanime, 40.0f))
			{
				...
				if(!(gSaveContext.eventChkInf[7] & 1))
				{
					TitleCard_InitBossName(globalCtx, &globalCtx->actorCtx.titleCtx, SEGMENTED_TO_VIRTUAL(gGohmaTitleCardTex), 0xA0, 0xB4, 0x80, 0x28);
				}
...
void BossGoma_Defeated(BossGoma* pthis, GlobalContext* globalCtx)
{
	...
	if(pthis->framesUntilNextAction < 1200 && pthis->framesUntilNextAction > 1100 && pthis->framesUntilNextAction % 8 == 0)
	{
	...
	if(pthis->framesUntilNextAction < 1080 && pthis->actionState < 3)
	{
		...
		for(i = 0; i < 15; i++)
		{
			...
			if(pthis->defeatedLimbPositions[j].y < 10000.0f)
			{
				...
				pos.y = Rand_CenteredFloat(10.0f) + pthis->defeatedLimbPositions[j].y;
				pos.z = Rand_CenteredFloat(20.0f) + pthis->defeatedLimbPositions[j].z;
				EffectSsHahen_Spawn(globalCtx, &pos, &vel2, &accel2, 0, (s16)(Rand_ZeroOne() * 5.0f) + 10, -1, 10, NULL);
			}
		}
	}
	...
	switch(pthis->actionState)
	{
		...
		case 2:
			...
			if(pthis->timer == 0)
			{
				...
				for(i = 0; i < 10000; i++)
				{
					if((fabsf(childPos.x - player->actor.world.pos.x) < 100.0f && fabsf(childPos.z - player->actor.world.pos.z) < 100.0f) ||
					   (fabsf(childPos.x - pthis->actor.world.pos.x) < 150.0f && fabsf(childPos.z - pthis->actor.world.pos.z) < 150.0f))
					{
				...
				Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_DOOR_WARP1, childPos.x, pthis->actor.world.pos.y, childPos.z, 0, 0, 0, WARP_DUNGEON_CHILD);
...
void BossGoma_FloorAttackPosture(BossGoma* pthis, GlobalContext* globalCtx)
{
	...
	{
		Math_ApproachS(&pthis->actor.world.rot.y, Actor_WorldYawTowardActor(&pthis->actor, &GET_PLAYER(globalCtx)->actor), 3, 0xBB8);
	}
...
void BossGoma_FloorAttack(BossGoma* pthis, GlobalContext* globalCtx)
{
	...
	switch(pthis->actionState)
	{
		case 0:
			...
			{
				pthis->actionState = 1;
				Animation_Change(&pthis->skelanime, &gGohmaRestAfterAttackAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaRestAfterAttackAnim), ANIMMODE_LOOP, -1.0f);
		...
		case 1:
			...
			{
				pthis->actionState = 2;
				Animation_Change(&pthis->skelanime, &gGohmaRecoverAfterAttackAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gGohmaRecoverAfterAttackAnim), ANIMMODE_ONCE, -5.0f);
			}
			break;
...
void BossGoma_CeilingIdle(BossGoma* pthis, GlobalContext* globalCtx)
{
	...
	if(pthis->framesUntilNextAction == 0)
	{
		...
		else if(pthis->childrenGohmaState[0] < 0 && pthis->childrenGohmaState[1] < 0 && pthis->childrenGohmaState[2] < 0)
		{
...
void BossGoma_CeilingMoveToCenter(BossGoma* pthis, GlobalContext* globalCtx)
{
	...
	if(pthis->framesUntilNextAction == 0 && fabsf(-150.0f - pthis->actor.world.pos.x) < 100.0f && fabsf(-350.0f - pthis->actor.world.pos.z) < 100.0f)
	{
		BossGoma_SetupCeilingIdle(pthis);
	}
}
...
void BossGoma_UpdateEye(BossGoma* pthis, GlobalContext* globalCtx)
{
	...
	if(!pthis->disableGameplayLogic)
	{
		...
		{
			targetEyeIrisRotY = Actor_WorldYawTowardActor(&pthis->actor, &GET_PLAYER(globalCtx)->actor) - pthis->actor.shape.rot.y;
			targetEyeIrisRotX = Actor_WorldPitchTowardActor(&pthis->actor, &GET_PLAYER(globalCtx)->actor) - pthis->actor.shape.rot.x;
...
void BossGoma_UpdateHit(BossGoma* pthis, GlobalContext* globalCtx)
{
	...
	else
	{
		...
		if(pthis->eyeClosedTimer == 0 && pthis->actionFunc != BossGoma_CeilingSpawnGohmas && (pthis->collider.elements[0].info.bumperFlags & BUMP_HIT))
		{
			pthis->collider.elements[0].info.bumperFlags &= ~BUMP_HIT;

			if(pthis->actionFunc == BossGoma_CeilingMoveToCenter || pthis->actionFunc == BossGoma_CeilingIdle || pthis->actionFunc == BossGoma_CeilingPrepareSpawnGohmas)
			{
				BossGoma_SetupFallStruckDown(pthis);
				Audio_PlayActorSound2(&pthis->actor, NA_SE_EN_GOMA_DAM2);
			}
			else if(pthis->actionFunc == BossGoma_FloorStunned && (damage = CollisionCheck_GetSwordDamage(acHitInfo->toucher.dmgFlags)) != 0)
			{
			...
			else if(pthis->actionFunc != BossGoma_FloorStunned && pthis->patienceTimer != 0 && (acHitInfo->toucher.dmgFlags & 0x00000005))
			{
				Audio_PlayActorSound2(&pthis->actor, NA_SE_EN_GOMA_DAM2);
...
void BossGoma_Update(Actor* thisx, GlobalContext* globalCtx)
{
	...
	if(!pthis->disableGameplayLogic)
	{
		...
		if(pthis->actionFunc != BossGoma_FloorStunned && pthis->actionFunc != BossGoma_FloorDamaged && (pthis->actionFunc != BossGoma_FloorMain || pthis->timer == 0))
		{
...
s32 BossGoma_OverrideLimbDraw(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx)
{
	BossGoma* pthis = (BossGoma*)thisx;
	...
	switch(limbIndex)
	{
		case BOSSGOMA_LIMB_EYE:
			...
			{
				gDPSetEnvColor(POLY_OPA_DISP++, (s16)(Rand_ZeroOne() * 255.0f), (s16)(Rand_ZeroOne() * 255.0f), (s16)(Rand_ZeroOne() * 255.0f), 63);
			}
			else
			{
				gDPSetEnvColor(POLY_OPA_DISP++, (s16)pthis->eyeEnvColor[0], (s16)pthis->eyeEnvColor[1], (s16)pthis->eyeEnvColor[2], 63);
			}
			break;
...
void BossGoma_PostLimbDraw(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx)
{
	...
	if(limbIndex == BOSSGOMA_LIMB_TAIL4)
	{ // tail end/last part
		Matrix_MultVec3f(&tailZero_189, &pthis->lastTailLimbWorldPos);
	}
	else if(limbIndex == BOSSGOMA_LIMB_TAIL1)
	...
	if(pthis->deadLimbsState[limbIndex] == 1)
	{
		...
		babyGohma = (EnGoma*)Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_EN_GOMA, childPos.x, childPos.y, childPos.z, childRot.x, childRot.y, childRot.z, sDeadLimbLifetime[limbIndex] + 100);
		if(babyGohma != NULL)
		{
...
void BossGoma_SpawnChildGohma(BossGoma* pthis, GlobalContext* globalCtx, s16 i)
{
	Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_EN_GOMA, pthis->lastTailLimbWorldPos.x, pthis->lastTailLimbWorldPos.y - 50.0f, pthis->lastTailLimbWorldPos.z, 0, i * (0x10000 / 3), 0, i);
