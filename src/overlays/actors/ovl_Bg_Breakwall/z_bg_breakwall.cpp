...
void BgBreakwall_Init(Actor* pthisx, GlobalContext* globalCtx) {
    ...
    pthis->bankIndex = (wallType >= BWALL_KD_FLOOR) ? Object_GetIndex(&globalCtx->objectCtx, OBJECT_KINGDODONGO)
 ...
 */
Actor* BgBreakwall_SpawnFragments(GlobalContext* globalCtx, BgBreakwall* pthis, Vec3f* pos, f32 velocity, f32 scaleY,
