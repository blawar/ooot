...
ActorInit Bg_Ice_Objects_InitVars = {
    ACTOR_BG_ICE_OBJECTS, ACTORCAT_PROP, FLAGS, OBJECT_ICE_OBJECTS, ACTOR_FACTORY(BgIceObjects), (ActorFunc)BgIceObjects_Init, (ActorFunc)BgIceObjects_Destroy, (ActorFunc)BgIceObjects_Update, (ActorFunc)BgIceObjects_Draw, (ActorFunc)BgIceObjects_Reset,
};
