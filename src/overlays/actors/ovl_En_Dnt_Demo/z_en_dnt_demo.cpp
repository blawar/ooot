...
static Vec3f sScrubPos[] = {
    {3810.0f, -20.0f, 1010.0f}, {3890.0f, -20.0f, 990.0f}, {3730.0f, -20.0f, 950.0f}, {3840.0f, -20.0f, 930.0f}, {3910.0f, -20.0f, 870.0f}, {3780.0f, -20.0f, 860.0f}, {3710.0f, -20.0f, 840.0f}, {3860.0f, -20.0f, 790.0f}, {3750.0f, -20.0f, 750.0f},
};
...
void EnDntDemo_Init(Actor* thisx, GlobalContext* globalCtx2)
{
	...
	for(i = 0; i < 9; i++)
	{
		...
		pthis->scrubs[i] = (EnDntNomal*)Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_EN_DNT_NOMAL, pthis->scrubPos[i].x, pthis->scrubPos[i].y, pthis->scrubPos[i].z, 0, 0, 0, i + ENDNTNOMAL_STAGE);
	...
	pthis->leader = (EnDntJiji*)Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_EN_DNT_JIJI, pthis->leaderPos.x, pthis->leaderPos.y, pthis->leaderPos.z, 0, 0, 0, 0);
