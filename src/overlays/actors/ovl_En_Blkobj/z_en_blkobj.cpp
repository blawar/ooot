...
void EnBlkobj_SpawnDarkLink(EnBlkobj* pthis, GlobalContext* globalCtx)
{
	...
	{
		Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_EN_TORCH2, pthis->dyna.actor.world.pos.x, pthis->dyna.actor.world.pos.y, pthis->dyna.actor.world.pos.z, 0, pthis->dyna.actor.yawTowardsPlayer, 0, 0);
