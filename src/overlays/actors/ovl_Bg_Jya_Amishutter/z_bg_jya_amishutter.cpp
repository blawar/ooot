...
void BgJyaAmishutter_InitDynaPoly(BgJyaAmishutter* pthis, GlobalContext* globalCtx, CollisionHeader* collision, s32 flag)
{
	s32 pad1;
	...
	{
		osSyncPrintf("Warning : move BG 登録失敗(%s %d)(name %d)(arg_data 0x%04x)\n", "../z_bg_jya_amishutter.c", 129, pthis->dyna.actor.id, pthis->dyna.actor.params);
	}
}
