...
static void* sEyeTextures[] = {gZelda2EyeOpenTex, gZelda2EyeHalfTex, gZelda2EyeShutTex, gZelda2Eye03Tex, gZelda2Eye04Tex, gZelda2Eye05Tex, gZelda2Eye06Tex, NULL};
...
{
	pthis->actor.bgCheckFlags &= ~(BG_STATE_0 | BG_STATE_3);
}
...
s32 func_80B5458C(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx, Gfx** gfx)
{
	s32 pad[3];
	EnZl3* pthis = (EnZl3*)thisx;
...
void func_80B54F18(EnZl3* pthis, GlobalContext* globalCtx)
{
	if(pthis->unk_2F8 == 0)
	{
		...
		Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_DOOR_WARP1, posX, posY, posZ, 0, 0x4000, 0, WARP_PURPLE_CRYSTAL);
		pthis->unk_2F8 = 1;
	}
}
...
void func_80B559C4(EnZl3* pthis)
{
	...
	Vec3f* unk_338 = &pthis->unk_338;
	f32 temp_f0 = Environment_LerpWeightAccelDecel(Animation_GetLastFrame(&gZelda2Anime2Anim_005248), 0, (s32)pthis->skelAnime.curFrame, 3, 3);
...
void func_80B56E38(EnZl3* pthis, GlobalContext* globalCtx)
{
	...
	if((Animation_OnFrame(sp20, 6.0f) || Animation_OnFrame(sp20, 0.0f)) && (pthis->actor.bgCheckFlags & BG_STATE_0))
	{
		sfxId = 0x800;
...
void func_80B57754(EnZl3* pthis, GlobalContext* globalCtx)
{
	...
	{
		Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_OCEFF_WIPE4, pthis->actor.world.pos.x, pthis->actor.world.pos.y, pthis->actor.world.pos.z, 0, 0, 0, 1);
...
void func_80B577BC(GlobalContext* globalCtx, Vec3f* vec)
{
	...
	Actor_Spawn(&globalCtx->actorCtx, globalCtx, ACTOR_EN_TEST, posX, posY, posZ, 0, (Math_FAtan2F(playerPos->x - posX, playerPos->z - posZ) * (0x8000 / M_PI)), 0, 5);
}
...
s32 func_80B57890(EnZl3* pthis, GlobalContext* globalCtx)
{
	...
	if(globalCtx)
	{
	} // Needed to match, pthis if can be almost anywhere and it still matches
...
s32 func_80B5944C(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx, Gfx** gfx)
{
	if(limbIndex == 14)
	{
...
{
	s32 cond = Flags_GetSwitch(globalCtx, 0x37) && ((globalCtx->sceneNum == SCENE_GANON_DEMO) || (globalCtx->sceneNum == SCENE_GANON_FINAL) || (globalCtx->sceneNum == SCENE_GANON_SONOGO) || (globalCtx->sceneNum == SCENE_GANONTIKA_SONOGO));

	if(cond)
	{
		u8 curSpawn = globalCtx->curSpawn;

		if((func_80B54DB4(pthis) == 0x20) && (curSpawn == 0) && ((gSaveContext.timer2Value <= 0) || (gSaveContext.timer2State == 0)))
		{
			return 1;
		}
	}
...
static EnZl3ActionFunc sActionFuncs[] = {
    func_80B59DB8, func_80B55550, func_80B555A4, func_80B55604, func_80B5566C, func_80B556CC, func_80B5572C, func_80B56658, func_80B566AC, func_80B5670C, func_80B5676C, func_80B567CC, func_80B5682C, func_80B568B4,
    func_80B5691C, func_80B5697C, func_80B569E4, func_80B56A68, func_80B56AE0, func_80B56B54, func_80B56BA8, func_80B56C24, func_80B56C84, func_80B56CE4, func_80B56D44, func_80B58D50, func_80B58DB0, func_80B58E10,
    func_80B58E7C, func_80B58EF4, func_80B58F6C, func_80B58FDC, func_80B5904C, func_80B590BC, func_80B5912C, func_80B591BC, func_80B5922C, func_80B592A8, func_80B59340, func_80B593D0,
};
...
s32 EnZl3_OverrideLimbDraw(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx, Gfx** gfx)
{
	EnZl3* pthis = (EnZl3*)thisx;
