...
static void* sMouthTextures[] = {
    gSariaMouthClosed2Tex, gSariaMouthSuprisedTex, gSariaMouthClosedTex, gSariaMouthSmilingOpenTex, gSariaMouthFrowningTex,
};
...
static DemoSaActionFunc sActionFuncs[] = {
    func_8098EBB8, func_8098EBD8, func_8098EBF8, func_8098EC28, func_8098EC60, func_8098EC94, func_8098ECCC, func_8098F0E8, func_8098F118, func_8098F16C, func_8098F3F0,
    func_8098F714, func_8098F734, func_8098F77C, func_8098F7BC, func_8098F7FC, func_8098FC44, func_8098FC64, func_8098FC9C, func_8098FCD4, func_8098FD0C,
};
...
void func_8098E8C8(DemoSa* pthis, GlobalContext* globalCtx)
{
	...
	Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_DEMO_EFFECT, posX, posY, posZ, 0, 0, 0, 0xB);
...
void func_8098EA68(DemoSa* pthis, GlobalContext* globalCtx)
{
	...
	if(globalCtx->csCtx.state != CS_STATE_IDLE)
	{
		...
		{
			Animation_Change(&pthis->skelAnime, &gSariaGiveForestMedallionAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gSariaGiveForestMedallionAnim), ANIMMODE_ONCE, -4.0f);
			pthis->action = 4;
		}
	}
}
...
void func_8098EB00(DemoSa* pthis, s32 arg1)
{
	if(arg1 != 0)
	{
		Animation_Change(&pthis->skelAnime, &gSariaGiveForestMedallionStandAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gSariaGiveForestMedallionStandAnim), ANIMMODE_LOOP, 0.0f);
		pthis->action = 5;
	}
}
...
{
	Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_DEMO_6K, pthis->actor.world.pos.x, (kREG(23) + 25.0f) + pthis->actor.world.pos.y, pthis->actor.world.pos.z, 0, 0, 0, 4);
}
...
void func_8098F83C(DemoSa* pthis, GlobalContext* globalCtx)
{
	...
	Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_EN_ELF, thisPos->x, thisPos->y, thisPos->z, 0, 0, 0, FAIRY_KOKIRI);
	pthis->action = 16;
	pthis->drawConfig = 0;
	pthis->actor.shape.shadowAlpha = 0;
