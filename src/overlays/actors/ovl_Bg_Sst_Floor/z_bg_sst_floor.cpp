...
void BgSstFloor_Update(BgSstFloor* thisx, GlobalContext* globalCtx)
{
	...
	colHeader->vtxList[1].y = colHeader->vtxList[0].y = colHeader->vtxList[2].y = colHeader->vtxList[3].y = colHeader->vtxList[4].y = colHeader->vtxList[7].y = colHeader->vtxList[9].y = colHeader->vtxList[11].y = colHeader->vtxList[13].y =
	    pthis->dyna.actor.home.pos.y + pthis->drumHeight;
