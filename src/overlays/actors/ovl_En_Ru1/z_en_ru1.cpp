...
static void* sEyeTextures[] = {
    gRutoChildEyeOpenTex, gRutoChildEyeHalfTex, gRutoChildEyeClosedTex, gRutoChildEyeRollLeftTex, gRutoChildEyeHalf2Tex, gRutoChildEyeHalfWithBlushTex,
};
...
static EnRu1ActionFunc sActionFuncs[] = {
    func_80AEC0B4, func_80AEC100, func_80AEC130, func_80AEC17C, func_80AEC1D4, func_80AEC244, func_80AEC2C0, func_80AECA94, func_80AECAB4, func_80AECAD4, func_80AECB18, func_80AECB60, func_80AECBB8, func_80AECC1C, func_80AECC84, func_80AED304,
    func_80AED324, func_80AED344, func_80AED374, func_80AED3A4, func_80AED3E0, func_80AED414, func_80AEF29C, func_80AEF2AC, func_80AEF2D0, func_80AEF354, func_80AEF3A8, func_80AEEBD4, func_80AEEC5C, func_80AEECF0, func_80AEED58, func_80AEEDCC,
    func_80AEEE34, func_80AEEE9C, func_80AEEF08, func_80AEEF5C, func_80AEF9D8, func_80AEFA2C, func_80AEFAAC, func_80AEFB04, func_80AEFB68, func_80AEFCE8, func_80AEFBC8, func_80AEFC24, func_80AEFECC, func_80AEFF40,
};
...
f32 func_80AEB7E0(CsCmdActorAction* csCmdNPCAction, GlobalContext* globalCtx)
{
	...
	{
		return (Math_CosS(((csCtxFrames - csCmdNPCAction->startFrame) / (f32)(csCmdNPCAction->endFrame - csCmdNPCAction->startFrame)) * 32768.0f) * -0.5f) + 0.5f;
	}
	return 1.0f;
}
...
void func_80AEBB78(EnRu1* pthis)
{
	...
	if(Animation_OnFrame(skelAnime, 4.0f) || Animation_OnFrame(skelAnime, 13.0f) || Animation_OnFrame(skelAnime, 22.0f) || Animation_OnFrame(skelAnime, 31.0f))
	{
...
void func_80AEBC30(GlobalContext* globalCtx)
{
	...
	if(globalCtx->csCtx.frames == 0xCD)
	{
		...
		Audio_PlaySoundGeneral(NA_SE_EV_DIVE_INTO_WATER, &player->actor.projectedPos, 4, &D_801333E0, &D_801333E0, &gReverbAdd2);
	}
}
...
void func_80AEBCB8(EnRu1* pthis, UNK_TYPE arg1)
{
	if(arg1 != 0)
	{
		Animation_Change(&pthis->skelAnime, &gRutoChildSwimOnBackAnim, 1.0f, 0, Animation_GetLastFrame(&gRutoChildSwimOnBackAnim), ANIMMODE_LOOP, -8.0f);
	}
}
...
void func_80AEBEC8(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	if(func_80AEB458(globalCtx, 6))
	{
		...
		func_80AEB738(pthis, globalCtx);
		Animation_Change(&pthis->skelAnime, &gRutoChildTransitionToSwimOnBackAnim, 1.0f, 0, frameCount, ANIMMODE_ONCE, -8.0f);
		pthis->action = 4;
	}
}
...
void func_80AEBFD8(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	if(csCmdNPCAction != NULL)
	{
		...
		if(csCtxFrames >= endFrame - 2)
		{
			...
			Animation_Change(&pthis->skelAnime, &gRutoChildTransitionFromSwimOnBackAnim, 1.0, 0, frameCount, ANIMMODE_ONCE, -8.0f);
			pthis->action = 6;
		}
	}
}
...
void func_80AEC320(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	else if((gSaveContext.infTable[20] & 0x80) && !(gSaveContext.infTable[20] & 1) && !(gSaveContext.infTable[20] & 0x20))
	{
...
void func_80AEC6E4(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	{
		Animation_Change(&pthis->skelAnime, &gRutoChildBringArmsUpAnim, 1.0f, 0, Animation_GetLastFrame(&gRutoChildBringArmsUpAnim), ANIMMODE_ONCE, -8.0f);
		pthis->unk_280 = 1;
		func_80AEC6B0(pthis);
	}
}
...
void func_80AEC8B8(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	{
		Animation_Change(&pthis->skelAnime, &gRutoChildTurnAroundAnim, 1.0f, 0, Animation_GetLastFrame(&gRutoChildTurnAroundAnim), ANIMMODE_ONCE, -8.0f);
		pthis->action = 10;
	}
}
...
void func_80AEC93C(EnRu1* pthis, UNK_TYPE arg1)
{
	if(arg1 != 0)
	{
		Animation_Change(&pthis->skelAnime, &gRutoChildWalkAnim, 1.0f, 0, Animation_GetLastFrame(&gRutoChildWalkAnim), ANIMMODE_LOOP, -8.0f);
...
void func_80AECCB0(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	pthis->blueWarp = (DoorWarp1*)Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_DOOR_WARP1, spawnX, spawnY, spawnZ, 0, yawTowardsPlayer, 0, WARP_BLUE_RUTO);
}
...
void func_80AED19C(EnRu1* pthis, s32 cond)
{
	if(cond)
	{
		Animation_Change(&pthis->skelAnime, &gRutoChildTransitionHandsOnHipToCrossArmsAndLegsAnim, 1.0f, 0, Animation_GetLastFrame(&gRutoChildTransitionHandsOnHipToCrossArmsAndLegsAnim), ANIMMODE_ONCE, -8.0f);
		pthis->action = 20;
...
void func_80AED218(EnRu1* pthis, UNK_TYPE arg1)
{
	if(func_80AED084(pthis, WARP_BLUE_RUTO_STATE_TALKING))
	{
		if(arg1 != 0)
		{
			Animation_Change(&pthis->skelAnime, &gRutoChildWaitSittingAnim, 1.0f, 0, Animation_GetLastFrame(&gRutoChildWaitSittingAnim), ANIMMODE_LOOP, -8.0f);
		}
	}
	else if(func_80AED084(pthis, WARP_BLUE_RUTO_STATE_WARPING))
	{
		Animation_Change(&pthis->skelAnime, &gRutoChildWaitInBlueWarpAnim, 1.0f, 0, Animation_GetLastFrame(&gRutoChildWaitInBlueWarpAnim), ANIMMODE_ONCE, -8.0f);
		pthis->action = 21;
...
void func_80AED44C(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	if((gSaveContext.infTable[20] & 2) && !(gSaveContext.infTable[20] & 0x20) && !(gSaveContext.infTable[20] & 1) && !(gSaveContext.infTable[20] & 0x80))
	{
		if(!func_80AEB020(pthis, globalCtx))
		{
			func_80AEB264(pthis, &gRutoChildWait2Anim, 0, 0, 0);
...
void func_80AED520(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	Audio_PlaySoundGeneral(NA_SE_PL_PULL_UP_RUTO, &player->actor.projectedPos, 4, &D_801333E0, &D_801333E0, &gReverbAdd2);
...
s32 func_80AED624(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	else if(((pthis->roomNum1 != curRoomNum) || (pthis->roomNum2 != curRoomNum)) && (pthis->actor.yDistToWater > kREG(16) + 50.0f) && (pthis->action != 33))
	{
		pthis->action = 33;
		pthis->drawConfig = 2;
		pthis->alpha = 0xFF;
...
s32 func_80AEE394(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	if((pthis->actor.bgCheckFlags & BG_STATE_0) && pthis->actor.floorBgId != BGCHECK_SCENE)
	{
		...
		if(dynaPolyActor != NULL && dynaPolyActor->actor.id == ACTOR_BG_BDAN_OBJECTS && dynaPolyActor->actor.params == 0 && !Player_InCsMode(globalCtx) && globalCtx->msgCtx.msgLength == 0)
		{
			func_80AEE02C(pthis);
...
void func_80AEE628(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	if(EnRu1_IsCsStateIdle(globalCtx))
	{
		Animation_Change(&pthis->skelAnime, &gRutoChildSittingAnim, 1.0f, 0, Animation_GetLastFrame(&gRutoChildSittingAnim), ANIMMODE_LOOP, -8.0f);
...
s32 func_80AEE6D0(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	if(!(gSaveContext.infTable[20] & 0x10) && (func_80AEB124(globalCtx) != 0))
	{
		...
		{
			Animation_Change(&pthis->skelAnime, &gRutoChildSeesSapphireAnim, 1.0f, 0, Animation_GetLastFrame(&gRutoChildSquirmAnim), ANIMMODE_LOOP, -8.0f);
			func_80AED600(pthis);
			pthis->action = 34;
			pthis->unk_26C = 0.0f;
		...
		if(pthis->action != 32)
		{
			if(*unk_370 > 30.0f)
			{
				if(Rand_S16Offset(0, 3) == 0)
				{
					...
					Animation_Change(&pthis->skelAnime, &gRutoChildSquirmAnim, 1.0f, 0, frameCount, ANIMMODE_LOOP, -8.0f);
					func_80AED5DC(pthis);
					pthis->action = 32;
				}
				*unk_370 = 0.0f;
...
void func_80AEF1F0(EnRu1* pthis, GlobalContext* globalCtx, UNK_TYPE arg2)
{
	if(arg2 != 0)
	{
		Animation_Change(&pthis->skelAnime, &gRutoChildSittingAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gRutoChildSittingAnim), ANIMMODE_LOOP, 0.0f);
		Message_CloseTextbox(globalCtx);
...
void func_80AEF40C(EnRu1* pthis)
{
	...
	if(Animation_OnFrame(skelAnime, 2.0f) || Animation_OnFrame(skelAnime, 7.0f) || Animation_OnFrame(skelAnime, 12.0f) || Animation_OnFrame(skelAnime, 18.0f) || Animation_OnFrame(skelAnime, 25.0f) || Animation_OnFrame(skelAnime, 33.0f))
	{
		Common_PlaySfxAtPos(&pthis->actor.projectedPos, NA_SE_PL_WALK_DIRT);
	}
}
...
void func_80AEF624(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	if(func_80AEAFE0(globalCtx, 1, 3))
	{
		...
		Animation_Change(&pthis->skelAnime, &gRutoChildWalkToAndHoldUpSapphireAnim, 1.0f, 0.0f, frameCount, ANIMMODE_ONCE, 0.0f);
...
void func_80AEF728(EnRu1* pthis, UNK_TYPE arg1)
{
	if(arg1 != 0)
	{
		Animation_Change(&pthis->skelAnime, &gRutoChildHoldArmsUpAnim, 1.0f, 0.0f, Animation_GetLastFrame(&gRutoChildHoldArmsUpAnim), ANIMMODE_LOOP, 0.0f);
		func_80AEB3CC(pthis);
		pthis->action = 38;
	}
}
...
void func_80AEF79C(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	{
		Animation_Change(&pthis->skelAnime, &gRutoChildBringHandsDownAnim, 1.0f, 0, Animation_GetLastFrame(&gRutoChildBringHandsDownAnim), ANIMMODE_ONCE, -8.0f);
		pthis->action = 39;
	}
}
...
void func_80AEF820(EnRu1* pthis, UNK_TYPE arg1)
{
	if(arg1 != 0)
	{
		Animation_Change(&pthis->skelAnime, &gRutoChildWait2Anim, 1.0f, 0, Animation_GetLastFrame(&gRutoChildWait2Anim), ANIMMODE_LOOP, -8.0f);
		pthis->action = 40;
	}
}
...
void func_80AEFF94(EnRu1* pthis, GlobalContext* globalCtx)
{
	...
	if((gSaveContext.infTable[20] & 2) && (gSaveContext.infTable[20] & 1) && !(gSaveContext.infTable[20] & 0x20) && (!(func_80AEB020(pthis, globalCtx))))
	{
		func_80AEB264(pthis, &gRutoChildWait2Anim, 0, 0, 0);
		actorRoom = pthis->actor.room;
		pthis->action = 22;
...
s32 EnRu1_OverrideLimbDraw(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx, Gfx** gfx)
{
	EnRu1* pthis = (EnRu1*)thisx;
