...
s32 EnPoDesert_OverrideLimbDraw(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx, Gfx** gfxP)
{
	EnPoDesert* pthis = (EnPoDesert*)thisx;
	f32 mtxScale;
...
void EnPoDesert_PostLimbDraw(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx, Gfx** gfxP)
{
	EnPoDesert* pthis = (EnPoDesert*)thisx;
	f32 rand;
	Color_RGBA8 color;
