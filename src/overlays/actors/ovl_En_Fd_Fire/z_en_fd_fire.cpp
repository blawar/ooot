...
void EnFdFire_Draw(Actor* thisx, GlobalContext* globalCtx)
{
	...
	gDPSetEnvColor(POLY_XLU_DISP++, envColors[((pthis->actor.params & 0x8000) >> 0xF)].r, envColors[((pthis->actor.params & 0x8000) >> 0xF)].g, envColors[((pthis->actor.params & 0x8000) >> 0xF)].b, envColors[((pthis->actor.params & 0x8000) >> 0xF)].a);
...
void EnFdFire_Reset(Actor* pthisx, GlobalContext* globalCtx)
{
	...
	sColChkInit = {1, 0, 0, 0, MASS_IMMOVABLE};
