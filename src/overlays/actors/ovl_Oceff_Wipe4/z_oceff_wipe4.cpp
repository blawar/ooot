...
ActorInit Oceff_Wipe4_InitVars = {
    ACTOR_OCEFF_WIPE4, ACTORCAT_ITEMACTION, FLAGS, OBJECT_GAMEPLAY_KEEP, ACTOR_FACTORY(OceffWipe4), (ActorFunc)OceffWipe4_Init, (ActorFunc)OceffWipe4_Destroy, (ActorFunc)OceffWipe4_Update, (ActorFunc)OceffWipe4_Draw, (ActorFunc)OceffWipe4_Reset,
};
...
void OceffWipe4_Draw(Actor* thisx, GlobalContext* globalCtx)
{
	...
	OPEN_DISPS(globalCtx->gfxCtx, "../z_oceff_wipe4.c", 314);
	...
	gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->gfxCtx, "../z_oceff_wipe4.c", 324), G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
