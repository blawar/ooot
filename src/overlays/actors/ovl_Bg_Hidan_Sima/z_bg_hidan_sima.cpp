...
void func_8088E5D0(BgHidanSima* pthis, GlobalContext* globalCtx)
{
	...
	if(pthis->timer != 0)
	{
		pthis->dyna.actor.world.pos.x = Math_SinS(pthis->dyna.actor.world.rot.y + (pthis->timer * 0x4000)) * 5.0f + pthis->dyna.actor.home.pos.x;
		pthis->dyna.actor.world.pos.z = Math_CosS(pthis->dyna.actor.world.rot.y + (pthis->timer * 0x4000)) * 5.0f + pthis->dyna.actor.home.pos.z;
	}
	else
	{
		pthis->actionFunc = func_8088E6D0;
