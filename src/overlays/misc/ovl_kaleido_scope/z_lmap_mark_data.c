...
PauseMapMarksData gPauseMapMarkDataTable[] = {
    ...
    {
        {
            PAUSE_MAP_MARK_CHEST, 23, sMarkChestVtx, 4, 2,
            {
                { 2, 40.0f, -33.0f },
                { 6, 49.0f, -42.0f },
            }
    ...
    {
        {
            PAUSE_MAP_MARK_CHEST, 23, sMarkChestVtx, 4, 1,
            {
                { 3, 84.0f, -39.0f },
            }
        },
    ...
    {
        {
            PAUSE_MAP_MARK_CHEST, 23, sMarkChestVtx, 4, 3,
            {
                { 10, 25.0f, -41.0f },
                { 4, 53.0f, -47.0f },
                { 6, 58.0f, -59.0f },
    ...
    {
        {
            PAUSE_MAP_MARK_CHEST, 23, sMarkChestVtx, 4, 7,
            {
                { 1, 50.0f, -12.0f },
                { 3, 46.0f, -66.0f },
                { 4, 20.0f, -38.0f },
    ...
    {
        {
            PAUSE_MAP_MARK_CHEST, 23, sMarkChestVtx, 4, 4,
            {
                { 0, 49.0f, -3.0f },
                { 2, 12.0f, -26.0f },
                { 5, 74.0f, -13.0f },
    ...
    {
        {
            PAUSE_MAP_MARK_CHEST, 23, sMarkChestVtx, 4, 6,
            {
                { 3, 76.0f, -48.0f },
                { 6, 72.0f, -50.0f },
                { 7, 44.0f, -17.0f },
    ...
    {
        {
            PAUSE_MAP_MARK_CHEST, 23, sMarkChestVtx, 4, 5,
            {
                { 0, 48.0f, -17.0f },
                { 1, 35.0f, -45.0f },
                { 2, 67.0f, -58.0f },
    ...
    {
        {
            PAUSE_MAP_MARK_CHEST, 23, sMarkChestVtx, 4, 10,
            {
                { 4, 43.0f, -66.0f },
                { 5, 37.0f, -66.0f },
                { 6, 33.0f, -72.0f },
    ...
    {
        {
            PAUSE_MAP_MARK_CHEST, 23, sMarkChestVtx, 4, 9,
            {
                { 1, 51.0f, -24.0f },
                { 3, 84.0f, -38.0f },
                { 4, 31.0f, -2.0f },
