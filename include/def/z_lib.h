...
f32 Math_SmoothStepToF(CounterF* pValue, f32 target, f32 fraction, const FStep& step, const FStep& minStep);
...
s32 Math_StepToF(CounterF* pValue, f32 target, const Step& step);
s32 Math_StepRotationToF(f32* pValue, f32 target, const Step& step);
s32 Math_StepRotationToF(CounterF* pValue, f32 target, const Step& step);
...
s32 Math_StepUntilF(CounterF* pValue, f32 limit, const Step& step);
