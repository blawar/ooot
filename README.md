...
after it's done type `cd ooot` and if you have the rom placed in this location `\ooot\roms\PAL_1.0\`
...
after it's done type `cd ooot` and if you have the rom placed in this location `\ooot\roms\EUR_MQD\`
